...
public class _wireSAFEARR_UNKNOWN {
    ...
    public static MemoryAddress apUnknown$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_wireSAFEARR_UNKNOWN.apUnknown$VH.get(seg);
    }
    ...
    public static MemoryAddress apUnknown$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_wireSAFEARR_UNKNOWN.apUnknown$VH.get(seg.asSlice(index*sizeof()));
    }
