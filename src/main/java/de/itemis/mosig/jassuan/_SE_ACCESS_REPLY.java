...
public class _SE_ACCESS_REPLY {
    ...
    static final VarHandle ResultListCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ResultListCount"));
    ...
    static final VarHandle GrantedAccess$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("GrantedAccess")));
    ...
    static final VarHandle AccessStatus$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("AccessStatus")));
    ...
    static final VarHandle AccessReason$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("AccessReason")));
