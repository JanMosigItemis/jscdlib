...
public class _IMAGE_ROM_OPTIONAL_HEADER {
    ...
    static final VarHandle BaseOfBss$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("BaseOfBss"));
    ...
    static final VarHandle GprMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("GprMask"));
    ...
    static final VarHandle GpValue$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("GpValue"));
