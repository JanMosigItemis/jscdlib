...
public class _FILETIME {
    ...
    static final VarHandle dwLowDateTime$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwLowDateTime"));
    ...
    static final VarHandle dwHighDateTime$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwHighDateTime"));
