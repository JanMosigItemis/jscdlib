...
public class _GLYPHMETRICS {
    ...
    static final VarHandle gmBlackBoxX$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("gmBlackBoxX"));
    ...
    static final VarHandle gmBlackBoxY$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("gmBlackBoxY"));
    ...
    static final VarHandle gmCellIncX$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("gmCellIncX"));
    ...
    static final VarHandle gmCellIncY$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("gmCellIncY"));
