...
public class _RPC_SERVER_INTERFACE {
    ...
    public static MemoryAddress DispatchTable$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.DispatchTable$VH.get(seg);
    }
    ...
    public static MemoryAddress DispatchTable$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.DispatchTable$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress RpcProtseqEndpoint$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.RpcProtseqEndpoint$VH.get(seg);
    }
    ...
    public static MemoryAddress RpcProtseqEndpoint$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.RpcProtseqEndpoint$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle DefaultManagerEpv$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("DefaultManagerEpv")));
    ...
    public static MemoryAddress DefaultManagerEpv$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.DefaultManagerEpv$VH.get(seg);
    }
    ...
    public static MemoryAddress DefaultManagerEpv$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.DefaultManagerEpv$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress InterpreterInfo$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.InterpreterInfo$VH.get(seg);
    }
    ...
    public static MemoryAddress InterpreterInfo$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SERVER_INTERFACE.InterpreterInfo$VH.get(seg.asSlice(index*sizeof()));
    }
