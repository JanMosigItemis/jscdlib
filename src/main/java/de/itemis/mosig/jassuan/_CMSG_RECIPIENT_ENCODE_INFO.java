...
public class _CMSG_RECIPIENT_ENCODE_INFO {
    ...
    public static MemoryAddress pKeyTrans$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCODE_INFO.pKeyTrans$VH.get(seg);
    }
    ...
    public static MemoryAddress pKeyTrans$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCODE_INFO.pKeyTrans$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pKeyAgree$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCODE_INFO.pKeyAgree$VH.get(seg);
    }
    ...
    public static MemoryAddress pKeyAgree$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCODE_INFO.pKeyAgree$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pMailList$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCODE_INFO.pMailList$VH.get(seg);
    }
    ...
    public static MemoryAddress pMailList$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCODE_INFO.pMailList$VH.get(seg.asSlice(index*sizeof()));
    }
