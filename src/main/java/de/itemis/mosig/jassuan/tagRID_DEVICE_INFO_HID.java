...
public class tagRID_DEVICE_INFO_HID {
    ...
    static final VarHandle dwVendorId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwVendorId"));
    ...
    static final VarHandle dwProductId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProductId"));
    ...
    static final VarHandle dwVersionNumber$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwVersionNumber"));
    ...
    static final VarHandle usUsagePage$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("usUsagePage"));
    ...
    static final VarHandle usUsage$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("usUsage"));
