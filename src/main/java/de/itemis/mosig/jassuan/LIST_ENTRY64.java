...
public class LIST_ENTRY64 {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG_LONG.withName("Flink"),
        C_LONG_LONG.withName("Blink")
    ).withName("LIST_ENTRY64");
    public static MemoryLayout $LAYOUT() {
        return LIST_ENTRY64.$struct$LAYOUT;
    }
    static final VarHandle Flink$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Flink"));
    ...
    static final VarHandle Blink$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Blink"));
