...
public class tagCIEXYZ {
    ...
    static final VarHandle ciexyzX$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ciexyzX"));
    ...
    static final VarHandle ciexyzY$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ciexyzY"));
    ...
    static final VarHandle ciexyzZ$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ciexyzZ"));
