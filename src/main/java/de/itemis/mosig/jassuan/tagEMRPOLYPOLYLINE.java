...
public class tagEMRPOLYPOLYLINE {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, C_LONG).withName("aPolyCounts"),
    ...
    static final VarHandle nPolys$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nPolys"));
    ...
    static final VarHandle cptl$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cptl"));
