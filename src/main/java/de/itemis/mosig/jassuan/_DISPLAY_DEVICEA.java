...
public class _DISPLAY_DEVICEA {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG.withName("cb"),
        MemoryLayout.sequenceLayout(32, C_CHAR).withName("DeviceName"),
        MemoryLayout.sequenceLayout(128, C_CHAR).withName("DeviceString"),
        C_LONG.withName("StateFlags"),
        MemoryLayout.sequenceLayout(128, C_CHAR).withName("DeviceID"),
        MemoryLayout.sequenceLayout(128, C_CHAR).withName("DeviceKey")
