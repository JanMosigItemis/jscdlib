...
public class _REPARSE_GUID_DATA_BUFFER {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(1, C_CHAR).withName("DataBuffer")
    ...
    static final VarHandle ReparseDataLength$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("ReparseDataLength"));
    ...
    public static class GenericReparseBuffer {
        ...
        static final MemoryLayout GenericReparseBuffer$struct$LAYOUT = MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(1, C_CHAR).withName("DataBuffer")
        );
        public static MemoryLayout $LAYOUT() {
