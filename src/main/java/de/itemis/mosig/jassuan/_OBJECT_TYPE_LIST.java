...
public class _OBJECT_TYPE_LIST {
    ...
    static final VarHandle Level$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("Level"));
    ...
    static final VarHandle Sbz$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("Sbz"));
    ...
    static final VarHandle ObjectType$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ObjectType")));
