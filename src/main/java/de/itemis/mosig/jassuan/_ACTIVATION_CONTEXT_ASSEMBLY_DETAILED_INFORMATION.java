...
public class _ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION {
    ...
    static final VarHandle ulEncodedAssemblyIdentityLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulEncodedAssemblyIdentityLength"));
    ...
    static final VarHandle ulManifestPathType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulManifestPathType"));
    ...
    static final VarHandle ulManifestPathLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulManifestPathLength"));
    ...
    static final VarHandle ulPolicyPathType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulPolicyPathType"));
    ...
    static final VarHandle ulPolicyPathLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulPolicyPathLength"));
    ...
    static final VarHandle ulMetadataSatelliteRosterIndex$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulMetadataSatelliteRosterIndex"));
    ...
    static final VarHandle ulManifestVersionMajor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulManifestVersionMajor"));
    ...
    static final VarHandle ulManifestVersionMinor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulManifestVersionMinor"));
    ...
    static final VarHandle ulPolicyVersionMajor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulPolicyVersionMajor"));
    ...
    static final VarHandle ulPolicyVersionMinor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulPolicyVersionMinor"));
    ...
    static final VarHandle ulAssemblyDirectoryNameLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulAssemblyDirectoryNameLength"));
    ...
    static final VarHandle lpAssemblyEncodedAssemblyIdentity$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpAssemblyEncodedAssemblyIdentity")));
    ...
    static final VarHandle lpAssemblyManifestPath$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpAssemblyManifestPath")));
    ...
    static final VarHandle lpAssemblyPolicyPath$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpAssemblyPolicyPath")));
    ...
    static final VarHandle lpAssemblyDirectoryName$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpAssemblyDirectoryName")));
    ...
    static final VarHandle ulFileCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulFileCount"));
