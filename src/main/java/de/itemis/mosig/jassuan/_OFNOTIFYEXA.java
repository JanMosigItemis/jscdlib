...
public class _OFNOTIFYEXA {
    ...
    public static MemoryAddress lpOFN$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXA.lpOFN$VH.get(seg);
    }
    ...
    public static MemoryAddress lpOFN$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXA.lpOFN$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress psf$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXA.psf$VH.get(seg);
    }
    ...
    public static MemoryAddress psf$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXA.psf$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pidl$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXA.pidl$VH.get(seg);
    }
    ...
    public static MemoryAddress pidl$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXA.pidl$VH.get(seg.asSlice(index*sizeof()));
    }
