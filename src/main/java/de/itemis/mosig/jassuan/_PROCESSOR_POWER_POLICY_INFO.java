...
public class _PROCESSOR_POWER_POLICY_INFO {
    ...
    static final VarHandle DemoteLimit$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("DemoteLimit"));
    ...
    static final VarHandle PromoteLimit$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PromoteLimit"));
