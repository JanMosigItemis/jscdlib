...
public class _DOC_INFO_3W {
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_3W.pDocName$VH.get(seg);
    }
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_3W.pDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_3W.pOutputFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_3W.pOutputFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_3W.pDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_3W.pDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
