...
public class _LOAD_DLL_DEBUG_INFO {
    ...
    static final VarHandle hFile$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hFile")));
    ...
    public static MemoryAddress hFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_LOAD_DLL_DEBUG_INFO.hFile$VH.get(seg);
    }
    ...
    public static MemoryAddress hFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_LOAD_DLL_DEBUG_INFO.hFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpBaseOfDll$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpBaseOfDll")));
    ...
    public static MemoryAddress lpBaseOfDll$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_LOAD_DLL_DEBUG_INFO.lpBaseOfDll$VH.get(seg);
    }
    ...
    public static MemoryAddress lpBaseOfDll$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_LOAD_DLL_DEBUG_INFO.lpBaseOfDll$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle dwDebugInfoFileOffset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwDebugInfoFileOffset"));
    ...
    static final VarHandle nDebugInfoSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nDebugInfoSize"));
    ...
    static final VarHandle lpImageName$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpImageName")));
    ...
    public static MemoryAddress lpImageName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_LOAD_DLL_DEBUG_INFO.lpImageName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpImageName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_LOAD_DLL_DEBUG_INFO.lpImageName$VH.get(seg.asSlice(index*sizeof()));
    }
