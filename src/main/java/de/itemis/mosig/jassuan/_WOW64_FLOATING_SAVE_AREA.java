...
public class _WOW64_FLOATING_SAVE_AREA {
    ...
    static final VarHandle ControlWord$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ControlWord"));
    ...
    static final VarHandle StatusWord$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("StatusWord"));
    ...
    static final VarHandle TagWord$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("TagWord"));
    ...
    static final VarHandle ErrorSelector$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ErrorSelector"));
    ...
    static final VarHandle DataSelector$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("DataSelector"));
    ...
    static final VarHandle Cr0NpxState$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Cr0NpxState"));
