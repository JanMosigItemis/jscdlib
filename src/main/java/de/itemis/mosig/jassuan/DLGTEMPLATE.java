...
public class DLGTEMPLATE {
    ...
    static final VarHandle dwExtendedStyle$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwExtendedStyle"));
    ...
    static final VarHandle cdit$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("cdit"));
    ...
    static final VarHandle cx$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("cx"));
    ...
    static final VarHandle cy$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("cy"));
