...
public class _TOKEN_DEFAULT_DACL {
    ...
    static final VarHandle DefaultDacl$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("DefaultDacl")));
