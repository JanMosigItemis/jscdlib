...
public class _CRYPT_CONTEXTS {
    ...
    static final VarHandle cContexts$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cContexts"));
    ...
    static final VarHandle rgpszContexts$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("rgpszContexts")));
    ...
    public static MemoryAddress rgpszContexts$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_CONTEXTS.rgpszContexts$VH.get(seg);
    }
    ...
    public static MemoryAddress rgpszContexts$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_CONTEXTS.rgpszContexts$VH.get(seg.asSlice(index*sizeof()));
    }
