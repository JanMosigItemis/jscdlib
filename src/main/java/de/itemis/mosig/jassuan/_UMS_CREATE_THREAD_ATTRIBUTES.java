...
public class _UMS_CREATE_THREAD_ATTRIBUTES {
    ...
    static final VarHandle UmsVersion$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("UmsVersion"));
    ...
    static final VarHandle UmsContext$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("UmsContext")));
    ...
    static final VarHandle UmsCompletionList$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("UmsCompletionList")));
