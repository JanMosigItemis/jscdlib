...
public class _PORT_INFO_1A {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_1A.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_1A.pName$VH.get(seg.asSlice(index*sizeof()));
    }
