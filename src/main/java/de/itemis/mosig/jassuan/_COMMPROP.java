...
public class _COMMPROP {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, C_SHORT).withName("wcProvChar"),
        MemoryLayout.paddingLayout(16)
    ).withName("_COMMPROP");
    public static MemoryLayout $LAYOUT() {
        return _COMMPROP.$struct$LAYOUT;
    }
    static final VarHandle wPacketLength$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wPacketLength"));
    ...
    static final VarHandle wPacketVersion$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wPacketVersion"));
    ...
    static final VarHandle dwServiceMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwServiceMask"));
    ...
    static final VarHandle dwMaxTxQueue$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwMaxTxQueue"));
    ...
    static final VarHandle dwMaxRxQueue$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwMaxRxQueue"));
    ...
    static final VarHandle dwMaxBaud$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwMaxBaud"));
    ...
    static final VarHandle dwProvSubType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProvSubType"));
    ...
    static final VarHandle dwProvCapabilities$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProvCapabilities"));
    ...
    static final VarHandle dwSettableParams$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwSettableParams"));
    ...
    static final VarHandle dwSettableBaud$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwSettableBaud"));
    ...
    static final VarHandle wSettableData$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wSettableData"));
    ...
    static final VarHandle wSettableStopParity$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wSettableStopParity"));
    ...
    static final VarHandle dwCurrentTxQueue$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCurrentTxQueue"));
    ...
    static final VarHandle dwCurrentRxQueue$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCurrentRxQueue"));
    ...
    static final VarHandle dwProvSpec1$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProvSpec1"));
    ...
    static final VarHandle dwProvSpec2$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProvSpec2"));
