...
public class tagCAH {
    ...
    public static MemoryAddress pElems$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCAH.pElems$VH.get(seg);
    }
    ...
    public static MemoryAddress pElems$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCAH.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
