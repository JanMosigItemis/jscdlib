...
public class tagRGBQUAD {
    ...
    static final VarHandle rgbBlue$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("rgbBlue"));
    ...
    static final VarHandle rgbGreen$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("rgbGreen"));
    ...
    static final VarHandle rgbRed$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("rgbRed"));
    ...
    static final VarHandle rgbReserved$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("rgbReserved"));
