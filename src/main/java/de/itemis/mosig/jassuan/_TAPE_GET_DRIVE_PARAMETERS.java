...
public class _TAPE_GET_DRIVE_PARAMETERS {
    ...
    static final VarHandle ECC$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ECC"));
    ...
    static final VarHandle Compression$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("Compression"));
    ...
    static final VarHandle DataPadding$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("DataPadding"));
    ...
    static final VarHandle ReportSetmarks$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ReportSetmarks"));
    ...
    static final VarHandle DefaultBlockSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("DefaultBlockSize"));
    ...
    static final VarHandle MaximumBlockSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MaximumBlockSize"));
    ...
    static final VarHandle MinimumBlockSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MinimumBlockSize"));
    ...
    static final VarHandle MaximumPartitionCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MaximumPartitionCount"));
    ...
    static final VarHandle FeaturesLow$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("FeaturesLow"));
    ...
    static final VarHandle FeaturesHigh$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("FeaturesHigh"));
    ...
    static final VarHandle EOTWarningZoneSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EOTWarningZoneSize"));
