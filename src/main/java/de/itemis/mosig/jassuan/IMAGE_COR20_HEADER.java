...
public class IMAGE_COR20_HEADER {
    ...
    static final VarHandle MajorRuntimeVersion$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("MajorRuntimeVersion"));
    ...
    static final VarHandle MinorRuntimeVersion$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("MinorRuntimeVersion"));
    ...
    static final VarHandle EntryPointToken$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("EntryPointToken"));
    ...
    static final VarHandle EntryPointRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("EntryPointRVA"));
