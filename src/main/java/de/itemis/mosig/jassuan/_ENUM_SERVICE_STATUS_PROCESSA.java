...
public class _ENUM_SERVICE_STATUS_PROCESSA {
    ...
    public static MemoryAddress lpServiceName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_ENUM_SERVICE_STATUS_PROCESSA.lpServiceName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpServiceName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_ENUM_SERVICE_STATUS_PROCESSA.lpServiceName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpDisplayName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_ENUM_SERVICE_STATUS_PROCESSA.lpDisplayName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDisplayName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_ENUM_SERVICE_STATUS_PROCESSA.lpDisplayName$VH.get(seg.asSlice(index*sizeof()));
    }
