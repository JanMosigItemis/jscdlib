...
public class _CRYPT_SEQUENCE_OF_ANY {
    ...
    public static MemoryAddress rgValue$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_SEQUENCE_OF_ANY.rgValue$VH.get(seg);
    }
    ...
    public static MemoryAddress rgValue$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_SEQUENCE_OF_ANY.rgValue$VH.get(seg.asSlice(index*sizeof()));
    }
