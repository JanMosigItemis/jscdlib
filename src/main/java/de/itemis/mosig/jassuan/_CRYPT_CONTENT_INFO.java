...
public class _CRYPT_CONTENT_INFO {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_CONTENT_INFO.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_CONTENT_INFO.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
