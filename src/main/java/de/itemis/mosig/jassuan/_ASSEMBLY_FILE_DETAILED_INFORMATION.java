...
public class _ASSEMBLY_FILE_DETAILED_INFORMATION {
    ...
    static final VarHandle ulFilenameLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulFilenameLength"));
    ...
    static final VarHandle ulPathLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulPathLength"));
    ...
    static final VarHandle lpFilePath$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpFilePath")));
