...
public class _REMSECURITY_ATTRIBUTES {
    ...
    static final VarHandle lpSecurityDescriptor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("lpSecurityDescriptor"));
    ...
    static final VarHandle bInheritHandle$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("bInheritHandle"));
