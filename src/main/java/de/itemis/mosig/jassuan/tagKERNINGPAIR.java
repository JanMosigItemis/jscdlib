...
public class tagKERNINGPAIR {
    ...
    static final VarHandle wFirst$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wFirst"));
    ...
    static final VarHandle iKernAmount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iKernAmount"));
