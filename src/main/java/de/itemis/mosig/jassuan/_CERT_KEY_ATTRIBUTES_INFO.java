...
public class _CERT_KEY_ATTRIBUTES_INFO {
    ...
    static final VarHandle pPrivateKeyUsagePeriod$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pPrivateKeyUsagePeriod")));
    ...
    public static MemoryAddress pPrivateKeyUsagePeriod$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_KEY_ATTRIBUTES_INFO.pPrivateKeyUsagePeriod$VH.get(seg);
    }
    ...
    public static MemoryAddress pPrivateKeyUsagePeriod$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_KEY_ATTRIBUTES_INFO.pPrivateKeyUsagePeriod$VH.get(seg.asSlice(index*sizeof()));
    }
