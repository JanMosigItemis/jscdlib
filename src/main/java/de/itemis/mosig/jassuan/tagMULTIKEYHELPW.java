...
public class tagMULTIKEYHELPW {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, C_SHORT).withName("szKeyphrase")
    ...
    static final VarHandle mkKeylist$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("mkKeylist"));
