...
public class _PRINTER_INFO_9A {
    ...
    public static MemoryAddress pDevMode$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_9A.pDevMode$VH.get(seg);
    }
    ...
    public static MemoryAddress pDevMode$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_9A.pDevMode$VH.get(seg.asSlice(index*sizeof()));
    }
