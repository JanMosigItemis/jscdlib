...
public class _IMAGE_DOS_HEADER {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, C_SHORT).withName("e_res"),
        C_SHORT.withName("e_oemid"),
        C_SHORT.withName("e_oeminfo"),
        MemoryLayout.sequenceLayout(10, C_SHORT).withName("e_res2"),
        C_LONG.withName("e_lfanew")
    ).withName("_IMAGE_DOS_HEADER");
    public static MemoryLayout $LAYOUT() {
        return _IMAGE_DOS_HEADER.$struct$LAYOUT;
    }
    static final VarHandle e_magic$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_magic"));
    ...
    static final VarHandle e_cblp$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_cblp"));
    ...
    static final VarHandle e_cp$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_cp"));
    ...
    static final VarHandle e_crlc$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_crlc"));
    ...
    static final VarHandle e_cparhdr$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_cparhdr"));
    ...
    static final VarHandle e_minalloc$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_minalloc"));
    ...
    static final VarHandle e_maxalloc$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_maxalloc"));
    ...
    static final VarHandle e_ss$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_ss"));
    ...
    static final VarHandle e_sp$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_sp"));
    ...
    static final VarHandle e_csum$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_csum"));
    ...
    static final VarHandle e_ip$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_ip"));
    ...
    static final VarHandle e_cs$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_cs"));
    ...
    static final VarHandle e_lfarlc$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_lfarlc"));
    ...
    static final VarHandle e_ovno$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_ovno"));
    ...
    static final VarHandle e_oemid$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_oemid"));
    ...
    static final VarHandle e_oeminfo$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("e_oeminfo"));
    ...
    static final VarHandle e_lfanew$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("e_lfanew"));
