...
public class _ACTIVATION_CONTEXT_DETAILED_INFORMATION {
    ...
    static final VarHandle ulFormatVersion$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulFormatVersion"));
    ...
    static final VarHandle ulAssemblyCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulAssemblyCount"));
    ...
    static final VarHandle ulRootManifestPathType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulRootManifestPathType"));
    ...
    static final VarHandle ulRootManifestPathChars$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulRootManifestPathChars"));
    ...
    static final VarHandle ulRootConfigurationPathType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulRootConfigurationPathType"));
    ...
    static final VarHandle ulRootConfigurationPathChars$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulRootConfigurationPathChars"));
    ...
    static final VarHandle ulAppDirPathType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulAppDirPathType"));
    ...
    static final VarHandle ulAppDirPathChars$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulAppDirPathChars"));
    ...
    static final VarHandle lpRootManifestPath$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpRootManifestPath")));
    ...
    static final VarHandle lpRootConfigurationPath$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpRootConfigurationPath")));
    ...
    static final VarHandle lpAppDirPath$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpAppDirPath")));
