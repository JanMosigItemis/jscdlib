...
public class _CERT_RDN_ATTR {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_RDN_ATTR.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_RDN_ATTR.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
