...
public class _DCB {
    ...
    static final VarHandle DCBlength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("DCBlength"));
    ...
    static final VarHandle BaudRate$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("BaudRate"));
    ...
    static final VarHandle XonLim$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("XonLim"));
    ...
    static final VarHandle XoffLim$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("XoffLim"));
    ...
    static final VarHandle ByteSize$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ByteSize"));
    ...
    static final VarHandle Parity$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("Parity"));
    ...
    static final VarHandle StopBits$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("StopBits"));
    ...
    static final VarHandle XonChar$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("XonChar"));
    ...
    static final VarHandle XoffChar$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("XoffChar"));
    ...
    static final VarHandle ErrorChar$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ErrorChar"));
    ...
    static final VarHandle EofChar$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("EofChar"));
    ...
    static final VarHandle EvtChar$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("EvtChar"));
