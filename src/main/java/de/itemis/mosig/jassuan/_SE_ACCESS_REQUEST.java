...
public class _SE_ACCESS_REQUEST {
    ...
    static final VarHandle SeSecurityDescriptor$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SeSecurityDescriptor")));
    ...
    static final VarHandle PreviouslyGrantedAccess$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PreviouslyGrantedAccess"));
    ...
    static final VarHandle PrincipalSelfSid$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("PrincipalSelfSid")));
    ...
    static final VarHandle GenericMapping$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("GenericMapping")));
    ...
    static final VarHandle ObjectTypeListCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ObjectTypeListCount"));
    ...
    static final VarHandle ObjectTypeList$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ObjectTypeList")));
