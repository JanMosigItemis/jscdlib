...
public class _CREATE_PROCESS_DEBUG_INFO {
    ...
    static final VarHandle lpBaseOfImage$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpBaseOfImage")));
