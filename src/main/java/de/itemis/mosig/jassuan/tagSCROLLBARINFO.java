...
public class tagSCROLLBARINFO {
    ...
    static final VarHandle dxyLineButton$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dxyLineButton"));
    ...
    static final VarHandle xyThumbTop$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("xyThumbTop"));
    ...
    static final VarHandle xyThumbBottom$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("xyThumbBottom"));
