...
public class _NT_TIB64 {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG_LONG.withName("ExceptionList"),
        C_LONG_LONG.withName("StackBase"),
        C_LONG_LONG.withName("StackLimit"),
        C_LONG_LONG.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            C_LONG_LONG.withName("FiberData"),
            C_LONG.withName("Version")
        ).withName("$anon$0"),
        C_LONG_LONG.withName("ArbitraryUserPointer"),
        C_LONG_LONG.withName("Self")
    ).withName("_NT_TIB64");
    public static MemoryLayout $LAYOUT() {
        return _NT_TIB64.$struct$LAYOUT;
    }
    static final VarHandle ExceptionList$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ExceptionList"));
    ...
    static final VarHandle StackBase$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("StackBase"));
    ...
    static final VarHandle StackLimit$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("StackLimit"));
    ...
    static final VarHandle SubSystemTib$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SubSystemTib"));
    ...
    static final VarHandle FiberData$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("FiberData"));
    ...
    static final VarHandle ArbitraryUserPointer$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ArbitraryUserPointer"));
    ...
    static final VarHandle Self$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Self"));
