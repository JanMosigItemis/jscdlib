...
public class _MEM_ADDRESS_REQUIREMENTS {
    ...
    static final VarHandle LowestStartingAddress$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("LowestStartingAddress")));
    ...
    static final VarHandle HighestEndingAddress$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("HighestEndingAddress")));
    ...
    static final VarHandle Alignment$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Alignment"));
