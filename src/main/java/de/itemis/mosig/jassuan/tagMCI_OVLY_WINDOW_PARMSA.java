...
public class tagMCI_OVLY_WINDOW_PARMSA {
    ...
    public static MemoryAddress hWnd$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_OVLY_WINDOW_PARMSA.hWnd$VH.get(seg);
    }
    ...
    public static MemoryAddress hWnd$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_OVLY_WINDOW_PARMSA.hWnd$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrText$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_OVLY_WINDOW_PARMSA.lpstrText$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrText$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_OVLY_WINDOW_PARMSA.lpstrText$VH.get(seg.asSlice(index*sizeof()));
    }
