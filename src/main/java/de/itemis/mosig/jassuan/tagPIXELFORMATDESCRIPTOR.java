...
public class tagPIXELFORMATDESCRIPTOR {
    ...
    static final VarHandle iLayerType$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("iLayerType"));
    ...
    static final VarHandle dwLayerMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwLayerMask"));
    ...
    static final VarHandle dwVisibleMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwVisibleMask"));
    ...
    static final VarHandle dwDamageMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwDamageMask"));
