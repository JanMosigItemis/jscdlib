...
public class _POWER_IDLE_RESILIENCY {
    ...
    static final VarHandle CoalescingTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("CoalescingTimeout"));
    ...
    static final VarHandle IdleResiliencyPeriod$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("IdleResiliencyPeriod"));
