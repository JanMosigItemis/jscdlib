...
public class sockaddr_in6 {
    ...
    static final VarHandle sin6_family$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("sin6_family"));
    ...
    static final VarHandle sin6_port$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("sin6_port"));
    ...
    static final VarHandle sin6_flowinfo$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("sin6_flowinfo"));
    ...
    static final VarHandle sin6_scope_id$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("sin6_scope_id"));
