...
public class tagSCROLLINFO {
    ...
    static final VarHandle nMin$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nMin"));
    ...
    static final VarHandle nMax$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nMax"));
    ...
    static final VarHandle nPage$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nPage"));
    ...
    static final VarHandle nPos$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nPos"));
    ...
    static final VarHandle nTrackPos$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nTrackPos"));
