...
public class tagCLIENTCREATESTRUCT {
    ...
    static final VarHandle hWindowMenu$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hWindowMenu")));
    ...
    static final VarHandle idFirstChild$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("idFirstChild"));
