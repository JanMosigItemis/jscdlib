...
public class tagXFORM {
    ...
    static final VarHandle eM11$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eM11"));
    ...
    static final VarHandle eM12$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eM12"));
    ...
    static final VarHandle eM21$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eM21"));
    ...
    static final VarHandle eM22$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eM22"));
    ...
    static final VarHandle eDx$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eDx"));
    ...
    static final VarHandle eDy$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eDy"));
