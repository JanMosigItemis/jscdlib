...
public class _RPC_SECURITY_QOS_V3_W {
    ...
    public static MemoryAddress Sid$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SECURITY_QOS_V3_W.Sid$VH.get(seg);
    }
    ...
    public static MemoryAddress Sid$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SECURITY_QOS_V3_W.Sid$VH.get(seg.asSlice(index*sizeof()));
    }
