...
public class _PRINTPROCESSOR_INFO_1W {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTPROCESSOR_INFO_1W.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTPROCESSOR_INFO_1W.pName$VH.get(seg.asSlice(index*sizeof()));
    }
