...
public class _ImageArchitectureEntry {
    ...
    static final VarHandle FixupInstRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("FixupInstRVA"));
    ...
    static final VarHandle NewInst$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("NewInst"));
