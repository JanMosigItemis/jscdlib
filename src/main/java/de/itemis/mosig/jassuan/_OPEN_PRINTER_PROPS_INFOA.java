...
public class _OPEN_PRINTER_PROPS_INFOA {
    ...
    public static MemoryAddress pszSheetName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OPEN_PRINTER_PROPS_INFOA.pszSheetName$VH.get(seg);
    }
    ...
    public static MemoryAddress pszSheetName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OPEN_PRINTER_PROPS_INFOA.pszSheetName$VH.get(seg.asSlice(index*sizeof()));
    }
