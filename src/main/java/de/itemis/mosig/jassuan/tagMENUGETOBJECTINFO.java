...
public class tagMENUGETOBJECTINFO {
    ...
    static final VarHandle uPos$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("uPos"));
    ...
    static final VarHandle riid$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("riid")));
    ...
    static final VarHandle pvObj$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pvObj")));
