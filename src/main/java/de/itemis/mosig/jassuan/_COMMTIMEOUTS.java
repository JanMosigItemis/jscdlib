...
public class _COMMTIMEOUTS {
    ...
    static final VarHandle ReadIntervalTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ReadIntervalTimeout"));
    ...
    static final VarHandle ReadTotalTimeoutMultiplier$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ReadTotalTimeoutMultiplier"));
    ...
    static final VarHandle ReadTotalTimeoutConstant$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ReadTotalTimeoutConstant"));
    ...
    static final VarHandle WriteTotalTimeoutMultiplier$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("WriteTotalTimeoutMultiplier"));
    ...
    static final VarHandle WriteTotalTimeoutConstant$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("WriteTotalTimeoutConstant"));
