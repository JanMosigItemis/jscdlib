...
public class tagMEASUREITEMSTRUCT {
    ...
    static final VarHandle itemWidth$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("itemWidth"));
    ...
    static final VarHandle itemHeight$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("itemHeight"));
