...
public class _IMAGE_OPTIONAL_HEADER64 {
    ...
    static final VarHandle SizeOfStackReserve$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SizeOfStackReserve"));
    ...
    static final VarHandle SizeOfStackCommit$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SizeOfStackCommit"));
    ...
    static final VarHandle SizeOfHeapReserve$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SizeOfHeapReserve"));
    ...
    static final VarHandle SizeOfHeapCommit$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SizeOfHeapCommit"));
