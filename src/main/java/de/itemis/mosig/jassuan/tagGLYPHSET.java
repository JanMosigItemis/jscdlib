...
public class tagGLYPHSET {
    ...
    static final VarHandle cbThis$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cbThis"));
    ...
    static final VarHandle flAccel$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("flAccel"));
    ...
    static final VarHandle cGlyphsSupported$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cGlyphsSupported"));
    ...
    static final VarHandle cRanges$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cRanges"));
