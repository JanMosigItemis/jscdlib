...
public class PPM_IDLE_STATE_ACCOUNTING_EX {
    ...
    static final VarHandle MinTimeUs$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MinTimeUs"));
    ...
    static final VarHandle MaxTimeUs$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MaxTimeUs"));
    ...
    static final VarHandle CancelledTransitions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("CancelledTransitions"));
