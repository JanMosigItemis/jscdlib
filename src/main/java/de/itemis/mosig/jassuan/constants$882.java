...
class constants$882 {
    ...
    static final FunctionDescriptor PFN_CERT_STORE_PROV_FIND_CTL$FUNC = FunctionDescriptor.of(C_INT,
        C_POINTER,
        C_POINTER,
        C_POINTER,
        C_LONG,
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_FIND_CTL$MH = RuntimeHelper.downcallHandle(
        ...
        constants$882.PFN_CERT_STORE_PROV_FIND_CTL$FUNC, false
    );
    static final FunctionDescriptor PFN_CERT_STORE_PROV_FREE_FIND_CTL$FUNC = FunctionDescriptor.of(C_INT,
        C_POINTER,
        C_POINTER,
        C_POINTER,
        C_LONG
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_FREE_FIND_CTL$MH = RuntimeHelper.downcallHandle(
        ...
        constants$882.PFN_CERT_STORE_PROV_FREE_FIND_CTL$FUNC, false
    );
    static final FunctionDescriptor PFN_CERT_STORE_PROV_GET_CTL_PROPERTY$FUNC = FunctionDescriptor.of(C_INT,
        C_POINTER,
        C_POINTER,
        C_LONG,
        C_LONG,
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_GET_CTL_PROPERTY$MH = RuntimeHelper.downcallHandle(
        ...
        constants$882.PFN_CERT_STORE_PROV_GET_CTL_PROPERTY$FUNC, false
    );
}
