...
public class _KCRM_PROTOCOL_BLOB {
    ...
    static final VarHandle StaticInfoLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("StaticInfoLength"));
    ...
    static final VarHandle TransactionIdInfoLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("TransactionIdInfoLength"));
    ...
    static final VarHandle Unused1$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Unused1"));
    ...
    static final VarHandle Unused2$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Unused2"));
