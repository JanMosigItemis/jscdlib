...
public class _MESSAGE_RESOURCE_BLOCK {
    ...
    static final VarHandle LowId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("LowId"));
    ...
    static final VarHandle HighId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("HighId"));
    ...
    static final VarHandle OffsetToEntries$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("OffsetToEntries"));
