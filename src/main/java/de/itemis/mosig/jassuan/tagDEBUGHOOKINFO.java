...
public class tagDEBUGHOOKINFO {
    ...
    static final VarHandle idThread$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("idThread"));
    ...
    static final VarHandle idThreadInstaller$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("idThreadInstaller"));
