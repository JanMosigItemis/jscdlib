...
public class _PRINTER_INFO_3 {
    ...
    public static MemoryAddress pSecurityDescriptor$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_3.pSecurityDescriptor$VH.get(seg);
    }
    ...
    public static MemoryAddress pSecurityDescriptor$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_3.pSecurityDescriptor$VH.get(seg.asSlice(index*sizeof()));
    }
