...
public class _SYSTEM_INFO {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_LONG_LONG.withName("dwActiveProcessorMask"),
    ...
    static final VarHandle dwOemId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("dwOemId"));
    ...
    static final VarHandle wProcessorArchitecture$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("wProcessorArchitecture"));
    ...
    static final VarHandle wReserved$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("wReserved"));
    ...
    static final VarHandle lpMinimumApplicationAddress$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpMinimumApplicationAddress")));
    ...
    static final VarHandle lpMaximumApplicationAddress$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpMaximumApplicationAddress")));
    ...
    static final VarHandle dwActiveProcessorMask$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("dwActiveProcessorMask"));
    ...
    static final VarHandle dwNumberOfProcessors$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwNumberOfProcessors"));
    ...
    static final VarHandle dwProcessorType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProcessorType"));
    ...
    static final VarHandle dwAllocationGranularity$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwAllocationGranularity"));
    ...
    static final VarHandle wProcessorLevel$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wProcessorLevel"));
    ...
    static final VarHandle wProcessorRevision$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wProcessorRevision"));
