...
public class _RESUME_PERFORMANCE {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_LONG_LONG.withName("TotalResumeTimeMs"),
        C_LONG_LONG.withName("ResumeCompleteTimestamp")
    ).withName("_RESUME_PERFORMANCE");
    public static MemoryLayout $LAYOUT() {
        return _RESUME_PERFORMANCE.$struct$LAYOUT;
    }
    static final VarHandle PostTimeMs$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PostTimeMs"));
    ...
    static final VarHandle TotalResumeTimeMs$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("TotalResumeTimeMs"));
    ...
    static final VarHandle ResumeCompleteTimestamp$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ResumeCompleteTimestamp"));
