...
public class tagCHOOSECOLORW {
    ...
    public static MemoryAddress hwndOwner$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.hwndOwner$VH.get(seg);
    }
    ...
    public static MemoryAddress hwndOwner$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.hwndOwner$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hInstance$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.hInstance$VH.get(seg);
    }
    ...
    public static MemoryAddress hInstance$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.hInstance$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle rgbResult$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("rgbResult"));
    ...
    static final VarHandle lpCustColors$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpCustColors")));
    ...
    public static MemoryAddress lpCustColors$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.lpCustColors$VH.get(seg);
    }
    ...
    public static MemoryAddress lpCustColors$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.lpCustColors$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpfnHook$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.lpfnHook$VH.get(seg);
    }
    ...
    public static MemoryAddress lpfnHook$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.lpfnHook$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static LPCCHOOKPROC lpfnHook (MemorySegment segment) {
        return LPCCHOOKPROC.ofAddress(lpfnHook$get(segment));
    }
    ...
    public static MemoryAddress lpTemplateName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.lpTemplateName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpTemplateName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCHOOSECOLORW.lpTemplateName$VH.get(seg.asSlice(index*sizeof()));
    }
