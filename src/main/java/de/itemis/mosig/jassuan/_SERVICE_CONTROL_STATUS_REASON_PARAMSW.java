...
public class _SERVICE_CONTROL_STATUS_REASON_PARAMSW {
    ...
    public static MemoryAddress pszComment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_CONTROL_STATUS_REASON_PARAMSW.pszComment$VH.get(seg);
    }
    ...
    public static MemoryAddress pszComment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_CONTROL_STATUS_REASON_PARAMSW.pszComment$VH.get(seg.asSlice(index*sizeof()));
    }
