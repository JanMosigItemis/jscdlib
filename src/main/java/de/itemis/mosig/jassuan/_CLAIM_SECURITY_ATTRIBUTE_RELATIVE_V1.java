...
public class _CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1 {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(1, C_LONG).withName("pInt64"),
            MemoryLayout.sequenceLayout(1, C_LONG).withName("pUint64"),
            MemoryLayout.sequenceLayout(1, C_LONG).withName("ppString"),
            MemoryLayout.sequenceLayout(1, C_LONG).withName("pFqbn"),
            MemoryLayout.sequenceLayout(1, C_LONG).withName("pOctetString")
        ).withName("Values")
