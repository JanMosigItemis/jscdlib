...
public class _IMAGE_ARCHIVE_MEMBER_HEADER {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(12, C_CHAR).withName("Date"),
        MemoryLayout.sequenceLayout(6, C_CHAR).withName("UserID"),
        MemoryLayout.sequenceLayout(6, C_CHAR).withName("GroupID"),
        MemoryLayout.sequenceLayout(8, C_CHAR).withName("Mode"),
        MemoryLayout.sequenceLayout(10, C_CHAR).withName("Size"),
        MemoryLayout.sequenceLayout(2, C_CHAR).withName("EndHeader")
