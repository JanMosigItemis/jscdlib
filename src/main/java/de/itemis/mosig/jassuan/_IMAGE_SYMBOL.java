...
public class _IMAGE_SYMBOL {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(8, C_CHAR).withName("ShortName"),
            MemoryLayout.structLayout(
                C_LONG.withName("Short"),
                C_LONG.withName("Long")
            ).withName("Name"),
            MemoryLayout.sequenceLayout(2, C_LONG).withName("LongName")
        ).withName("N"),
    ...
    public static class N {
        ...
        static final MemoryLayout N$union$LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(8, C_CHAR).withName("ShortName"),
            MemoryLayout.structLayout(
                C_LONG.withName("Short"),
                C_LONG.withName("Long")
        ...
        public static class Name {
            ...
            static final MemoryLayout N$Name$struct$LAYOUT = MemoryLayout.structLayout(
                C_LONG.withName("Short"),
                C_LONG.withName("Long")
            );
            public static MemoryLayout $LAYOUT() {
            ...
            static final VarHandle Short$VH = N$Name$struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Short"));
            ...
            static final VarHandle Long$VH = N$Name$struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Long"));
    ...
    static final VarHandle SectionNumber$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("SectionNumber"));
    ...
    static final VarHandle StorageClass$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("StorageClass"));
    ...
    static final VarHandle NumberOfAuxSymbols$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("NumberOfAuxSymbols"));
