...
public class _OCSP_BASIC_RESPONSE_INFO {
    ...
    static final VarHandle dwResponderIdChoice$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwResponderIdChoice"));
    ...
    static final VarHandle cResponseEntry$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cResponseEntry"));
    ...
    static final VarHandle rgResponseEntry$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("rgResponseEntry")));
    ...
    public static MemoryAddress rgResponseEntry$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OCSP_BASIC_RESPONSE_INFO.rgResponseEntry$VH.get(seg);
    }
    ...
    public static MemoryAddress rgResponseEntry$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OCSP_BASIC_RESPONSE_INFO.rgResponseEntry$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress rgExtension$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OCSP_BASIC_RESPONSE_INFO.rgExtension$VH.get(seg);
    }
    ...
    public static MemoryAddress rgExtension$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OCSP_BASIC_RESPONSE_INFO.rgExtension$VH.get(seg.asSlice(index*sizeof()));
    }
