...
public class _SHORT_SIZEDARR {
    ...
    public static MemoryAddress pData$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SHORT_SIZEDARR.pData$VH.get(seg);
    }
    ...
    public static MemoryAddress pData$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SHORT_SIZEDARR.pData$VH.get(seg.asSlice(index*sizeof()));
    }
