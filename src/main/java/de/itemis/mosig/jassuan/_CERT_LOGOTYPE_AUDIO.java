...
public class _CERT_LOGOTYPE_AUDIO {
    ...
    static final VarHandle pLogotypeAudioInfo$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pLogotypeAudioInfo")));
    ...
    public static MemoryAddress pLogotypeAudioInfo$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_LOGOTYPE_AUDIO.pLogotypeAudioInfo$VH.get(seg);
    }
    ...
    public static MemoryAddress pLogotypeAudioInfo$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_LOGOTYPE_AUDIO.pLogotypeAudioInfo$VH.get(seg.asSlice(index*sizeof()));
    }
