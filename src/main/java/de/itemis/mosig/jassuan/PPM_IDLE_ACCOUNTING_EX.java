...
public class PPM_IDLE_ACCOUNTING_EX {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_LONG_LONG.withName("StartTime"),
        MemoryLayout.sequenceLayout(1, MemoryLayout.structLayout(
            ...
            MemoryLayout.sequenceLayout(16, MemoryLayout.structLayout(
                C_LONG_LONG.withName("TotalTimeUs"),
                C_LONG.withName("MinTimeUs"),
                C_LONG.withName("MaxTimeUs"),
    ...
    static final VarHandle StateCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("StateCount"));
    ...
    static final VarHandle TotalTransitions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("TotalTransitions"));
    ...
    static final VarHandle ResetCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ResetCount"));
    ...
    static final VarHandle AbortCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AbortCount"));
    ...
    static final VarHandle StartTime$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("StartTime"));
