...
public class _WSANAMESPACE_INFOEXA {
    ...
    public static MemoryAddress lpszIdentifier$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSANAMESPACE_INFOEXA.lpszIdentifier$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszIdentifier$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSANAMESPACE_INFOEXA.lpszIdentifier$VH.get(seg.asSlice(index*sizeof()));
    }
