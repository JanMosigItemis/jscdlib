...
public class tagENHMETAHEADER {
    ...
    static final VarHandle nBytes$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nBytes"));
    ...
    static final VarHandle nRecords$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nRecords"));
    ...
    static final VarHandle nHandles$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("nHandles"));
    ...
    static final VarHandle sReserved$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("sReserved"));
    ...
    static final VarHandle nDescription$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nDescription"));
    ...
    static final VarHandle offDescription$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("offDescription"));
    ...
    static final VarHandle cbPixelFormat$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cbPixelFormat"));
    ...
    static final VarHandle offPixelFormat$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("offPixelFormat"));
    ...
    static final VarHandle bOpenGL$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("bOpenGL"));
