...
public class _MODEMSETTINGS {
    ...
    static final VarHandle dwPreferredModemOptions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwPreferredModemOptions"));
    ...
    static final VarHandle dwNegotiatedModemOptions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwNegotiatedModemOptions"));
    ...
    static final VarHandle dwNegotiatedDCERate$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwNegotiatedDCERate"));
