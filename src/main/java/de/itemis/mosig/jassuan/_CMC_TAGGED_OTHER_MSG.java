...
public class _CMC_TAGGED_OTHER_MSG {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CMC_TAGGED_OTHER_MSG.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CMC_TAGGED_OTHER_MSG.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
