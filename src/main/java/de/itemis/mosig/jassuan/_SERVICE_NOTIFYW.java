...
public class _SERVICE_NOTIFYW {
    ...
    ).withName("_SERVICE_NOTIFYW");
    public static MemoryLayout $LAYOUT() {
        return _SERVICE_NOTIFYW.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwVersion$VH() {
        return _SERVICE_NOTIFYW.dwVersion$VH;
    }
    public static int dwVersion$get(MemorySegment seg) {
        return (int)_SERVICE_NOTIFYW.dwVersion$VH.get(seg);
    }
    public static void dwVersion$set( MemorySegment seg, int x) {
        _SERVICE_NOTIFYW.dwVersion$VH.set(seg, x);
    }
    public static int dwVersion$get(MemorySegment seg, long index) {
        return (int)_SERVICE_NOTIFYW.dwVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwVersion$set(MemorySegment seg, long index, int x) {
        _SERVICE_NOTIFYW.dwVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pfnNotifyCallback$VH() {
        return _SERVICE_NOTIFYW.pfnNotifyCallback$VH;
    }
    public static MemoryAddress pfnNotifyCallback$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFYW.pfnNotifyCallback$VH.get(seg);
    }
    public static void pfnNotifyCallback$set( MemorySegment seg, MemoryAddress x) {
        _SERVICE_NOTIFYW.pfnNotifyCallback$VH.set(seg, x);
    }
    public static MemoryAddress pfnNotifyCallback$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFYW.pfnNotifyCallback$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pfnNotifyCallback$set(MemorySegment seg, long index, MemoryAddress x) {
        _SERVICE_NOTIFYW.pfnNotifyCallback$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pContext$VH() {
        return _SERVICE_NOTIFYW.pContext$VH;
    }
    public static MemoryAddress pContext$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFYW.pContext$VH.get(seg);
    }
    public static void pContext$set( MemorySegment seg, MemoryAddress x) {
        _SERVICE_NOTIFYW.pContext$VH.set(seg, x);
    }
    public static MemoryAddress pContext$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFYW.pContext$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pContext$set(MemorySegment seg, long index, MemoryAddress x) {
        _SERVICE_NOTIFYW.pContext$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwNotificationStatus$VH() {
        return _SERVICE_NOTIFYW.dwNotificationStatus$VH;
    }
    public static int dwNotificationStatus$get(MemorySegment seg) {
        return (int)_SERVICE_NOTIFYW.dwNotificationStatus$VH.get(seg);
    }
    public static void dwNotificationStatus$set( MemorySegment seg, int x) {
        _SERVICE_NOTIFYW.dwNotificationStatus$VH.set(seg, x);
    }
    public static int dwNotificationStatus$get(MemorySegment seg, long index) {
        return (int)_SERVICE_NOTIFYW.dwNotificationStatus$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwNotificationStatus$set(MemorySegment seg, long index, int x) {
        _SERVICE_NOTIFYW.dwNotificationStatus$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwNotificationTriggered$VH() {
        return _SERVICE_NOTIFYW.dwNotificationTriggered$VH;
    }
    public static int dwNotificationTriggered$get(MemorySegment seg) {
        return (int)_SERVICE_NOTIFYW.dwNotificationTriggered$VH.get(seg);
    }
    public static void dwNotificationTriggered$set( MemorySegment seg, int x) {
        _SERVICE_NOTIFYW.dwNotificationTriggered$VH.set(seg, x);
    }
    public static int dwNotificationTriggered$get(MemorySegment seg, long index) {
        return (int)_SERVICE_NOTIFYW.dwNotificationTriggered$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwNotificationTriggered$set(MemorySegment seg, long index, int x) {
        _SERVICE_NOTIFYW.dwNotificationTriggered$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pszServiceNames$VH() {
        return _SERVICE_NOTIFYW.pszServiceNames$VH;
    }
    public static MemoryAddress pszServiceNames$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFYW.pszServiceNames$VH.get(seg);
    }
    public static void pszServiceNames$set( MemorySegment seg, MemoryAddress x) {
        _SERVICE_NOTIFYW.pszServiceNames$VH.set(seg, x);
    }
    public static MemoryAddress pszServiceNames$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFYW.pszServiceNames$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszServiceNames$set(MemorySegment seg, long index, MemoryAddress x) {
        _SERVICE_NOTIFYW.pszServiceNames$VH.set(seg.asSlice(index*sizeof()), x);
    }
