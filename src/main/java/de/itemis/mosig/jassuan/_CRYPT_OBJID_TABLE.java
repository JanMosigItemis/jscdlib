...
public class _CRYPT_OBJID_TABLE {
    ...
    static final VarHandle dwAlgId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwAlgId"));
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_OBJID_TABLE.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_OBJID_TABLE.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
