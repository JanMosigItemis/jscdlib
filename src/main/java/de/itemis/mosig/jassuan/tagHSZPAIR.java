...
public class tagHSZPAIR {
    ...
    public static MemoryAddress hszSvc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagHSZPAIR.hszSvc$VH.get(seg);
    }
    ...
    public static MemoryAddress hszSvc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagHSZPAIR.hszSvc$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hszTopic$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagHSZPAIR.hszTopic$VH.get(seg);
    }
    ...
    public static MemoryAddress hszTopic$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagHSZPAIR.hszTopic$VH.get(seg.asSlice(index*sizeof()));
    }
