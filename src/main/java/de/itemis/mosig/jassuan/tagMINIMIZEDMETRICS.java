...
public class tagMINIMIZEDMETRICS {
    ...
    static final VarHandle iWidth$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iWidth"));
    ...
    static final VarHandle iHorzGap$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iHorzGap"));
    ...
    static final VarHandle iVertGap$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iVertGap"));
    ...
    static final VarHandle iArrange$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iArrange"));
