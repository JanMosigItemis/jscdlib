...
public class _RPC_SECURITY_QOS_V3_A {
    ...
    static final VarHandle Sid$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Sid")));
    public static VarHandle Sid$VH() {
        return _RPC_SECURITY_QOS_V3_A.Sid$VH;
    }
    public static MemoryAddress Sid$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SECURITY_QOS_V3_A.Sid$VH.get(seg);
    }
    ...
    public static MemoryAddress Sid$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RPC_SECURITY_QOS_V3_A.Sid$VH.get(seg.asSlice(index*sizeof()));
    }
