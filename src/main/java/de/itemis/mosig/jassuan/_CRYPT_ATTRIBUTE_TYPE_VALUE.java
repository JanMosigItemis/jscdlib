...
public class _CRYPT_ATTRIBUTE_TYPE_VALUE {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_ATTRIBUTE_TYPE_VALUE.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_ATTRIBUTE_TYPE_VALUE.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
