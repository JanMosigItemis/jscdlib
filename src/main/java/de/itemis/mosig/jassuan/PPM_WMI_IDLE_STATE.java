...
public class PPM_WMI_IDLE_STATE {
    ...
    static final VarHandle StateType$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("StateType"));
    ...
    static final VarHandle Context$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Context"));
    ...
    static final VarHandle IdleHandler$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("IdleHandler"));
