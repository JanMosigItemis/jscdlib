...
public class _NETRESOURCEA {
    ...
    static final VarHandle dwScope$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwScope"));
    ...
    static final VarHandle dwDisplayType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwDisplayType"));
    ...
    static final VarHandle dwUsage$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwUsage"));
    ...
    public static MemoryAddress lpLocalName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpLocalName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpLocalName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpLocalName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpRemoteName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpRemoteName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpRemoteName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpRemoteName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpComment$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpComment")));
    ...
    public static MemoryAddress lpComment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpComment$VH.get(seg);
    }
    ...
    public static MemoryAddress lpComment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpComment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpProvider$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpProvider")));
    ...
    public static MemoryAddress lpProvider$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpProvider$VH.get(seg);
    }
    ...
    public static MemoryAddress lpProvider$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_NETRESOURCEA.lpProvider$VH.get(seg.asSlice(index*sizeof()));
    }
