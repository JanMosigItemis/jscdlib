...
public class _PROCESSOR_GROUP_INFO {
    ...
    static final VarHandle MaximumProcessorCount$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("MaximumProcessorCount"));
    ...
    static final VarHandle ActiveProcessorCount$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ActiveProcessorCount"));
    ...
    static final VarHandle ActiveProcessorMask$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ActiveProcessorMask"));
