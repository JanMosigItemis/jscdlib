...
public class tagSERIALKEYSA {
    ...
    static final VarHandle lpszActivePort$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpszActivePort")));
    ...
    public static MemoryAddress lpszActivePort$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagSERIALKEYSA.lpszActivePort$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszActivePort$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagSERIALKEYSA.lpszActivePort$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpszPort$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpszPort")));
    ...
    public static MemoryAddress lpszPort$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagSERIALKEYSA.lpszPort$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszPort$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagSERIALKEYSA.lpszPort$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle iBaudRate$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iBaudRate"));
    ...
    static final VarHandle iPortState$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iPortState"));
    ...
    static final VarHandle iActive$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iActive"));
