...
public class tagBITMAPCOREHEADER {
    ...
    static final VarHandle bcSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("bcSize"));
    ...
    static final VarHandle bcWidth$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bcWidth"));
    ...
    static final VarHandle bcHeight$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bcHeight"));
    ...
    static final VarHandle bcPlanes$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bcPlanes"));
    ...
    static final VarHandle bcBitCount$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bcBitCount"));
