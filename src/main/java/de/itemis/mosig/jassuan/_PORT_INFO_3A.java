...
public class _PORT_INFO_3A {
    ...
    public static MemoryAddress pszStatus$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_3A.pszStatus$VH.get(seg);
    }
    ...
    public static MemoryAddress pszStatus$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_3A.pszStatus$VH.get(seg.asSlice(index*sizeof()));
    }
