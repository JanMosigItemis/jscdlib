...
public class tagMCI_LOAD_PARMSW {
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_LOAD_PARMSW.lpfilename$VH.get(seg);
    }
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_LOAD_PARMSW.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
