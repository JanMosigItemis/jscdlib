...
public class _PRINTER_DEFAULTSW {
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_DEFAULTSW.pDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_DEFAULTSW.pDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDevMode$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_DEFAULTSW.pDevMode$VH.get(seg);
    }
    ...
    public static MemoryAddress pDevMode$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_DEFAULTSW.pDevMode$VH.get(seg.asSlice(index*sizeof()));
    }
