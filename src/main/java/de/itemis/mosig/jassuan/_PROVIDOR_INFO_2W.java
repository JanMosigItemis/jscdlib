...
public class _PROVIDOR_INFO_2W {
    ...
    public static MemoryAddress pOrder$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PROVIDOR_INFO_2W.pOrder$VH.get(seg);
    }
    ...
    public static MemoryAddress pOrder$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PROVIDOR_INFO_2W.pOrder$VH.get(seg.asSlice(index*sizeof()));
    }
