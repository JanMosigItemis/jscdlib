...
public class _ROOT_INFO_LUID {
    ...
    static final VarHandle LowPart$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("LowPart"));
    ...
    static final VarHandle HighPart$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("HighPart"));
