...
public class _SE_IMPERSONATION_STATE {
    ...
    static final VarHandle Token$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Token")));
    ...
    static final VarHandle CopyOnOpen$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("CopyOnOpen"));
    ...
    static final VarHandle EffectiveOnly$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("EffectiveOnly"));
    ...
    static final VarHandle Level$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Level"));
