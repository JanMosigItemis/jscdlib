...
public class _SERVICE_DESCRIPTIONW {
    ...
    public static MemoryAddress lpDescription$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_DESCRIPTIONW.lpDescription$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDescription$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_DESCRIPTIONW.lpDescription$VH.get(seg.asSlice(index*sizeof()));
    }
