...
public class _IMAGE_IMPORT_DESCRIPTOR {
    ...
    static final VarHandle Characteristics$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("Characteristics"));
    ...
    static final VarHandle OriginalFirstThunk$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("OriginalFirstThunk"));
    ...
    static final VarHandle ForwarderChain$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ForwarderChain"));
    ...
    static final VarHandle FirstThunk$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("FirstThunk"));
