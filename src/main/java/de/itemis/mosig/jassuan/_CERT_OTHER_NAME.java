...
public class _CERT_OTHER_NAME {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_OTHER_NAME.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_OTHER_NAME.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
