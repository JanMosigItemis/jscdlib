...
public class _SYSTEM_POWER_POLICY {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(2, C_CHAR).withName("Spare2"),
        ...
        MemoryLayout.sequenceLayout(3, C_LONG).withName("VideoReserved"),
    ...
    static final VarHandle LidOpenWake$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("LidOpenWake"));
    ...
    static final VarHandle IdleTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("IdleTimeout"));
    ...
    static final VarHandle IdleSensitivity$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("IdleSensitivity"));
    ...
    static final VarHandle MinSleep$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MinSleep"));
    ...
    static final VarHandle MaxSleep$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MaxSleep"));
    ...
    static final VarHandle ReducedLatencySleep$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ReducedLatencySleep"));
    ...
    static final VarHandle WinLogonFlags$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("WinLogonFlags"));
    ...
    static final VarHandle Spare3$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Spare3"));
    ...
    static final VarHandle DozeS4Timeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("DozeS4Timeout"));
    ...
    static final VarHandle BroadcastCapacityResolution$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("BroadcastCapacityResolution"));
    ...
    static final VarHandle VideoTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("VideoTimeout"));
    ...
    static final VarHandle VideoDimDisplay$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("VideoDimDisplay"));
    ...
    static final VarHandle SpindownTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("SpindownTimeout"));
    ...
    static final VarHandle OptimizeForPower$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("OptimizeForPower"));
    ...
    static final VarHandle FanThrottleTolerance$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("FanThrottleTolerance"));
    ...
    static final VarHandle ForcedThrottle$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ForcedThrottle"));
