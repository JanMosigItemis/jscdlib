...
public class _OFNOTIFYEXW {
    ...
    public static MemoryAddress lpOFN$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXW.lpOFN$VH.get(seg);
    }
    ...
    public static MemoryAddress lpOFN$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXW.lpOFN$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle psf$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("psf")));
    public static VarHandle psf$VH() {
        return _OFNOTIFYEXW.psf$VH;
    }
    public static MemoryAddress psf$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXW.psf$VH.get(seg);
    }
    ...
    public static MemoryAddress psf$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXW.psf$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle pidl$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pidl")));
    public static VarHandle pidl$VH() {
        return _OFNOTIFYEXW.pidl$VH;
    }
    public static MemoryAddress pidl$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXW.pidl$VH.get(seg);
    }
    ...
    public static MemoryAddress pidl$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYEXW.pidl$VH.get(seg.asSlice(index*sizeof()));
    }
