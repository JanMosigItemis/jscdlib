...
public class _CERT_POLICY_ID {
    ...
    static final VarHandle cCertPolicyElementId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cCertPolicyElementId"));
    ...
    static final VarHandle rgpszCertPolicyElementId$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("rgpszCertPolicyElementId")));
    ...
    public static MemoryAddress rgpszCertPolicyElementId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_POLICY_ID.rgpszCertPolicyElementId$VH.get(seg);
    }
    ...
    public static MemoryAddress rgpszCertPolicyElementId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_POLICY_ID.rgpszCertPolicyElementId$VH.get(seg.asSlice(index*sizeof()));
    }
