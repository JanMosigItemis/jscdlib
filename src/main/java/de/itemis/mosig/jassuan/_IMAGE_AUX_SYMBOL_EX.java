...
public class _IMAGE_AUX_SYMBOL_EX {
    ...
    static final MemoryLayout $union$LAYOUT = MemoryLayout.unionLayout(
        ...
        MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(20, C_CHAR).withName("Name")
        ).withName("File"),
        MemoryLayout.structLayout(
            ...
            MemoryLayout.sequenceLayout(2, C_CHAR).withName("rgbReserved")
        ).withName("Section"),
        MemoryLayout.structLayout(
            MemoryLayout.structLayout(
        ...
        MemoryLayout.structLayout(
            C_LONG.withName("crc"),
            MemoryLayout.sequenceLayout(16, C_CHAR).withName("rgbReserved")
        ).withName("CRC")
    ...
    public static class Sym {
        ...
        static final VarHandle WeakDefaultSymIndex$VH = Sym$struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("WeakDefaultSymIndex"));
        ...
        static final VarHandle WeakSearchType$VH = Sym$struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("WeakSearchType"));
    ...
    public static class Section {
        ...
        static final VarHandle bReserved$VH = Section$struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bReserved"));
        ...
        static final VarHandle HighNumber$VH = Section$struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("HighNumber"));
