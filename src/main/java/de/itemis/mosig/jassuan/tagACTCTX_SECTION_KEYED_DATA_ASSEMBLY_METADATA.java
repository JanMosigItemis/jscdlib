...
public class tagACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA {
    ...
    static final VarHandle lpInformation$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpInformation")));
    ...
    static final VarHandle ulSectionLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ulSectionLength"));
    ...
    static final VarHandle lpSectionGlobalDataBase$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpSectionGlobalDataBase")));
