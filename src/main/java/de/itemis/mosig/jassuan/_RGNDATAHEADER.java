...
public class _RGNDATAHEADER {
    ...
    static final VarHandle nCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nCount"));
    ...
    static final VarHandle nRgnSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nRgnSize"));
