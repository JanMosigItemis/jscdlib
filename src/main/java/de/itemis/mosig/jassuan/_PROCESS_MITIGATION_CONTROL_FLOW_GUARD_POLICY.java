    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("EnableControlFlowGuard"),
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("EnableExportSuppression"),
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("StrictMode"),
