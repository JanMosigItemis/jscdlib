...
public class _OSVERSIONINFOEXW {
    ...
    static final VarHandle wServicePackMajor$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wServicePackMajor"));
    ...
    static final VarHandle wServicePackMinor$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wServicePackMinor"));
    ...
    static final VarHandle wSuiteMask$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wSuiteMask"));
    ...
    static final VarHandle wProductType$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("wProductType"));
    ...
    static final VarHandle wReserved$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("wReserved"));
