...
public class _PRINTER_ENUM_VALUESW {
    ...
    public static MemoryAddress pValueName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_ENUM_VALUESW.pValueName$VH.get(seg);
    }
    ...
    public static MemoryAddress pValueName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_ENUM_VALUESW.pValueName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pData$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_ENUM_VALUESW.pData$VH.get(seg);
    }
    ...
    public static MemoryAddress pData$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_ENUM_VALUESW.pData$VH.get(seg.asSlice(index*sizeof()));
    }
