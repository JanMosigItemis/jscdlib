...
public class _CRYPTOAPI_BLOB {
    ...
    public static MemoryAddress pbData$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPTOAPI_BLOB.pbData$VH.get(seg);
    }
    ...
    public static MemoryAddress pbData$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPTOAPI_BLOB.pbData$VH.get(seg.asSlice(index*sizeof()));
    }
