...
public class _WSAQUERYSET2A {
    ...
    public static MemoryAddress lpszServiceInstanceName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszServiceInstanceName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszServiceInstanceName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszServiceInstanceName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpVersion$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpVersion$VH.get(seg);
    }
    ...
    public static MemoryAddress lpVersion$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszComment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszComment$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszComment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszComment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpNSProviderId$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpNSProviderId$VH.get(seg);
    }
    ...
    public static MemoryAddress lpNSProviderId$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpNSProviderId$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszContext$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszContext$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszContext$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszContext$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpafpProtocols$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpafpProtocols$VH.get(seg);
    }
    ...
    public static MemoryAddress lpafpProtocols$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpafpProtocols$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszQueryString$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszQueryString$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszQueryString$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpszQueryString$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpcsaBuffer$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpcsaBuffer$VH.get(seg);
    }
    ...
    public static MemoryAddress lpcsaBuffer$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpcsaBuffer$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpBlob$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpBlob$VH.get(seg);
    }
    ...
    public static MemoryAddress lpBlob$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSAQUERYSET2A.lpBlob$VH.get(seg.asSlice(index*sizeof()));
    }
