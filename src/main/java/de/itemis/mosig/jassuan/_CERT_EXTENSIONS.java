...
public class _CERT_EXTENSIONS {
    ...
    public static MemoryAddress rgExtension$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_EXTENSIONS.rgExtension$VH.get(seg);
    }
    ...
    public static MemoryAddress rgExtension$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CERT_EXTENSIONS.rgExtension$VH.get(seg.asSlice(index*sizeof()));
    }
