...
public class _SECURITY_DESCRIPTOR_RELATIVE {
    ...
    static final VarHandle Owner$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Owner"));
    ...
    static final VarHandle Group$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Group"));
    ...
    static final VarHandle Sacl$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Sacl"));
    ...
    static final VarHandle Dacl$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Dacl"));
