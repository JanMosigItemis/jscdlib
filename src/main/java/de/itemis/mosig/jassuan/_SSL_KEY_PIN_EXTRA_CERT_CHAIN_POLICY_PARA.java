...
public class _SSL_KEY_PIN_EXTRA_CERT_CHAIN_POLICY_PARA {
    ...
    public static MemoryAddress pwszServerName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SSL_KEY_PIN_EXTRA_CERT_CHAIN_POLICY_PARA.pwszServerName$VH.get(seg);
    }
    ...
    public static MemoryAddress pwszServerName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SSL_KEY_PIN_EXTRA_CERT_CHAIN_POLICY_PARA.pwszServerName$VH.get(seg.asSlice(index*sizeof()));
    }
