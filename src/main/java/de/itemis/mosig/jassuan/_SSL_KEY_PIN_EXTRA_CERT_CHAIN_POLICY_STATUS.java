...
public class _SSL_KEY_PIN_EXTRA_CERT_CHAIN_POLICY_STATUS {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(512, C_SHORT).withName("wszErrorText")
    ...
    static final VarHandle lError$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("lError"));
