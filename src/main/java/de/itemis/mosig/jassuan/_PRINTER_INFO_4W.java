...
public class _PRINTER_INFO_4W {
    ...
    public static MemoryAddress pPrinterName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_4W.pPrinterName$VH.get(seg);
    }
    ...
    public static MemoryAddress pPrinterName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_4W.pPrinterName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pServerName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_4W.pServerName$VH.get(seg);
    }
    ...
    public static MemoryAddress pServerName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_4W.pServerName$VH.get(seg.asSlice(index*sizeof()));
    }
