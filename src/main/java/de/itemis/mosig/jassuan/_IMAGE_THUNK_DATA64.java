...
public class _IMAGE_THUNK_DATA64 {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            C_LONG_LONG.withName("ForwarderString"),
            C_LONG_LONG.withName("Function"),
            C_LONG_LONG.withName("Ordinal"),
            C_LONG_LONG.withName("AddressOfData")
        ).withName("u1")
    ...
    public static class u1 {
        ...
        static final VarHandle ForwarderString$VH = u1$union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ForwarderString"));
        ...
        static final VarHandle Function$VH = u1$union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Function"));
        ...
        static final VarHandle Ordinal$VH = u1$union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Ordinal"));
        ...
        static final VarHandle AddressOfData$VH = u1$union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("AddressOfData"));
