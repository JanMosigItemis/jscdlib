...
public class IXMLDOMNodeList {
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)IXMLDOMNodeList.lpVtbl$VH.get(seg);
    }
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)IXMLDOMNodeList.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
