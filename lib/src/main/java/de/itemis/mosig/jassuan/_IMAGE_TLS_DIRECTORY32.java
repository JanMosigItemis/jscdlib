...
public class _IMAGE_TLS_DIRECTORY32 {
    ...
    static final VarHandle StartAddressOfRawData$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("StartAddressOfRawData"));
    ...
    static final VarHandle EndAddressOfRawData$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EndAddressOfRawData"));
    ...
    static final VarHandle AddressOfIndex$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AddressOfIndex"));
    ...
    static final VarHandle AddressOfCallBacks$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AddressOfCallBacks"));
