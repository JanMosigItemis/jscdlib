...
public class _ADMINISTRATOR_POWER_POLICY {
    ...
    static final VarHandle MinVideoTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MinVideoTimeout"));
    ...
    static final VarHandle MaxVideoTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MaxVideoTimeout"));
    ...
    static final VarHandle MinSpindownTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MinSpindownTimeout"));
    ...
    static final VarHandle MaxSpindownTimeout$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("MaxSpindownTimeout"));
