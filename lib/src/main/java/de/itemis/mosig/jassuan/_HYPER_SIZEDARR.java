...
public class _HYPER_SIZEDARR {
    ...
    public static MemoryAddress pData$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_HYPER_SIZEDARR.pData$VH.get(seg);
    }
    ...
    public static MemoryAddress pData$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_HYPER_SIZEDARR.pData$VH.get(seg.asSlice(index*sizeof()));
    }
