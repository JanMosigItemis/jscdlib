...
public class tagTRACKMOUSEEVENT {
    ...
    static final VarHandle hwndTrack$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hwndTrack")));
    ...
    static final VarHandle dwHoverTime$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwHoverTime"));
