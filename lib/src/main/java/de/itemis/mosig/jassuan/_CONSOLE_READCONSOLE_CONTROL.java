...
public class _CONSOLE_READCONSOLE_CONTROL {
    ...
    static final VarHandle nLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nLength"));
    ...
    static final VarHandle nInitialChars$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nInitialChars"));
    ...
    static final VarHandle dwCtrlWakeupMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCtrlWakeupMask"));
