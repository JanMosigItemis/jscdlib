...
public class _RTL_CRITICAL_SECTION_DEBUG {
    ...
    static final VarHandle CreatorBackTraceIndex$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("CreatorBackTraceIndex"));
    ...
    static final VarHandle CriticalSection$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("CriticalSection")));
    ...
    static final VarHandle EntryCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EntryCount"));
    ...
    static final VarHandle ContentionCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ContentionCount"));
    ...
    static final VarHandle CreatorBackTraceIndexHigh$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("CreatorBackTraceIndexHigh"));
    ...
    static final VarHandle SpareWORD$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("SpareWORD"));
