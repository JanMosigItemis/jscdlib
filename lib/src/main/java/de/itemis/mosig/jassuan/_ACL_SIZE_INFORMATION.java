...
public class _ACL_SIZE_INFORMATION {
    ...
    static final VarHandle AceCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AceCount"));
    ...
    static final VarHandle AclBytesInUse$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AclBytesInUse"));
    ...
    static final VarHandle AclBytesFree$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AclBytesFree"));
