...
public class _CERT_TRUST_STATUS {
    ...
    static final VarHandle dwErrorStatus$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwErrorStatus"));
    ...
    static final VarHandle dwInfoStatus$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwInfoStatus"));
