...
public class _POINTFLOAT {
    ...
    static final VarHandle x$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("x"));
    ...
    static final VarHandle y$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("y"));
