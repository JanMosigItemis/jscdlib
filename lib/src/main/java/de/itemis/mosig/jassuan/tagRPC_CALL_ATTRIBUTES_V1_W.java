...
public class tagRPC_CALL_ATTRIBUTES_V1_W {
    ...
    public static MemoryAddress ServerPrincipalName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_W.ServerPrincipalName$VH.get(seg);
    }
    ...
    public static MemoryAddress ServerPrincipalName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_W.ServerPrincipalName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress ClientPrincipalName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_W.ClientPrincipalName$VH.get(seg);
    }
    ...
    public static MemoryAddress ClientPrincipalName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_W.ClientPrincipalName$VH.get(seg.asSlice(index*sizeof()));
    }
