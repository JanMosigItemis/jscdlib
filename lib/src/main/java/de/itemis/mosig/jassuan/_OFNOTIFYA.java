...
public class _OFNOTIFYA {
    ...
    public static MemoryAddress lpOFN$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYA.lpOFN$VH.get(seg);
    }
    ...
    public static MemoryAddress lpOFN$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYA.lpOFN$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pszFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYA.pszFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pszFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_OFNOTIFYA.pszFile$VH.get(seg.asSlice(index*sizeof()));
    }
