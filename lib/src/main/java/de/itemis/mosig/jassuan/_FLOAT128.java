...
public class _FLOAT128 {
    ...
    static final VarHandle LowPart$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("LowPart"));
    ...
    static final VarHandle HighPart$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("HighPart"));
