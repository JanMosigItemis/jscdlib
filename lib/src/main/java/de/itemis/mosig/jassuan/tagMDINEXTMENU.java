...
public class tagMDINEXTMENU {
    ...
    static final VarHandle hmenuIn$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hmenuIn")));
    ...
    static final VarHandle hmenuNext$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hmenuNext")));
    ...
    static final VarHandle hwndNext$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hwndNext")));
