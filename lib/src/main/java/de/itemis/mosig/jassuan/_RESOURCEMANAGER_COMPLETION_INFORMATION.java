...
public class _RESOURCEMANAGER_COMPLETION_INFORMATION {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_LONG_LONG.withName("CompletionKey")
    ).withName("_RESOURCEMANAGER_COMPLETION_INFORMATION");
    public static MemoryLayout $LAYOUT() {
        return _RESOURCEMANAGER_COMPLETION_INFORMATION.$struct$LAYOUT;
    }
    static final VarHandle IoCompletionPortHandle$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("IoCompletionPortHandle")));
    ...
    static final VarHandle CompletionKey$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("CompletionKey"));
