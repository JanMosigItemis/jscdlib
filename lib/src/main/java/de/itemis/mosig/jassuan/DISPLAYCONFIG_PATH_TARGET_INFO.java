...
public class DISPLAYCONFIG_PATH_TARGET_INFO {
    ...
    static final VarHandle rotation$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("rotation"));
    ...
    static final VarHandle scaling$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("scaling"));
    ...
    static final VarHandle targetAvailable$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("targetAvailable"));
