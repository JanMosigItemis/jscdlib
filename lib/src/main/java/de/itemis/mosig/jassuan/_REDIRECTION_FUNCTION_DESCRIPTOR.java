...
public class _REDIRECTION_FUNCTION_DESCRIPTOR {
    ...
    static final VarHandle FunctionName$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("FunctionName")));
    ...
    static final VarHandle RedirectionTarget$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("RedirectionTarget")));
