...
public class tagPARAMDATA {
    ...
    public static MemoryAddress szName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagPARAMDATA.szName$VH.get(seg);
    }
    ...
    public static MemoryAddress szName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagPARAMDATA.szName$VH.get(seg.asSlice(index*sizeof()));
    }
