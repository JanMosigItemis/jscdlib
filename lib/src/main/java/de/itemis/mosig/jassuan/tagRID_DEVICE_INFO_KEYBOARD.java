...
public class tagRID_DEVICE_INFO_KEYBOARD {
    ...
    static final VarHandle dwSubType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwSubType"));
    ...
    static final VarHandle dwKeyboardMode$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwKeyboardMode"));
    ...
    static final VarHandle dwNumberOfFunctionKeys$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwNumberOfFunctionKeys"));
    ...
    static final VarHandle dwNumberOfIndicators$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwNumberOfIndicators"));
    ...
    static final VarHandle dwNumberOfKeysTotal$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwNumberOfKeysTotal"));
