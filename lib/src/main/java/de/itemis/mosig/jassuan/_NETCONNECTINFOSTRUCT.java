...
public class _NETCONNECTINFOSTRUCT {
    ...
    static final VarHandle dwDelay$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwDelay"));
    ...
    static final VarHandle dwOptDataSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwOptDataSize"));
