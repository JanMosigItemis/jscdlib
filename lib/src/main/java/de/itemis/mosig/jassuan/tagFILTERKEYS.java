...
public class tagFILTERKEYS {
    ...
    static final VarHandle iWaitMSec$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iWaitMSec"));
    ...
    static final VarHandle iDelayMSec$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iDelayMSec"));
    ...
    static final VarHandle iRepeatMSec$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iRepeatMSec"));
    ...
    static final VarHandle iBounceMSec$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iBounceMSec"));
