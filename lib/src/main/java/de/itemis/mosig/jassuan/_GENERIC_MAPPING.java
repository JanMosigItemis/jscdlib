...
public class _GENERIC_MAPPING {
    ...
    static final VarHandle GenericRead$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("GenericRead"));
    ...
    static final VarHandle GenericWrite$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("GenericWrite"));
    ...
    static final VarHandle GenericExecute$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("GenericExecute"));
    ...
    static final VarHandle GenericAll$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("GenericAll"));
