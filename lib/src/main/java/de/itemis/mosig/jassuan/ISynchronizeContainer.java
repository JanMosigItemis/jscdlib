...
public class ISynchronizeContainer {
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)ISynchronizeContainer.lpVtbl$VH.get(seg);
    }
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)ISynchronizeContainer.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
