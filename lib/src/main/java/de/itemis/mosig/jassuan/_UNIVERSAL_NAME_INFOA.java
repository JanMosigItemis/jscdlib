...
public class _UNIVERSAL_NAME_INFOA {
    ...
    public static MemoryAddress lpUniversalName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_UNIVERSAL_NAME_INFOA.lpUniversalName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpUniversalName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_UNIVERSAL_NAME_INFOA.lpUniversalName$VH.get(seg.asSlice(index*sizeof()));
    }
