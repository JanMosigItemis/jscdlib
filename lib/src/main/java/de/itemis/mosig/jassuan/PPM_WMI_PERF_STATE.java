...
public class PPM_WMI_PERF_STATE {
    ...
    static final VarHandle Frequency$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Frequency"));
    ...
    static final VarHandle Power$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Power"));
    ...
    static final VarHandle PercentFrequency$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("PercentFrequency"));
    ...
    static final VarHandle IncreaseLevel$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("IncreaseLevel"));
    ...
    static final VarHandle DecreaseLevel$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("DecreaseLevel"));
    ...
    static final VarHandle Control$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Control"));
    ...
    static final VarHandle Status$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Status"));
    ...
    static final VarHandle HitCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("HitCount"));
