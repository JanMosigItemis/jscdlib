...
public class _QUERY_SERVICE_LOCK_STATUSA {
    ...
    static final VarHandle fIsLocked$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("fIsLocked"));
    ...
    static final VarHandle lpLockOwner$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpLockOwner")));
    ...
    public static MemoryAddress lpLockOwner$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_QUERY_SERVICE_LOCK_STATUSA.lpLockOwner$VH.get(seg);
    }
    ...
    public static MemoryAddress lpLockOwner$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_QUERY_SERVICE_LOCK_STATUSA.lpLockOwner$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle dwLockDuration$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwLockDuration"));
