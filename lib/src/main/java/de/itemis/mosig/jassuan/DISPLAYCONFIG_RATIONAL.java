...
public class DISPLAYCONFIG_RATIONAL {
    ...
    static final VarHandle Numerator$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Numerator"));
    ...
    static final VarHandle Denominator$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Denominator"));
