...
public class _ULARGE_INTEGER {
    ...
    static final VarHandle LowPart$VH = $union$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("LowPart"));
    ...
    static final VarHandle HighPart$VH = $union$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("HighPart"));
    ...
    public static class u {
        ...
        static final MemoryLayout u$struct$LAYOUT = MemoryLayout.structLayout(
            C_LONG.withName("LowPart"),
            C_LONG.withName("HighPart")
        );
        public static MemoryLayout $LAYOUT() {
        ...
        static final VarHandle LowPart$VH = u$struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("LowPart"));
        public static VarHandle LowPart$VH() {
            return u.LowPart$VH;
        }
        public static int LowPart$get(MemorySegment seg) {
        ...
        static final VarHandle HighPart$VH = u$struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("HighPart"));
        public static VarHandle HighPart$VH() {
    ...
    static final VarHandle QuadPart$VH = $union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("QuadPart"));
