...
public class _TP_CALLBACK_ENVIRON_V3 {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("LongFunction"),
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("Persistent"),
                    MemoryLayout.valueLayout(30, ByteOrder.nativeOrder()).withName("Private")
                )
            ).withName("s")
        ).withName("u"),
    ...
    static final VarHandle Pool$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Pool")));
    ...
    static final VarHandle CleanupGroup$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("CleanupGroup")));
    ...
    static final VarHandle CleanupGroupCancelCallback$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("CleanupGroupCancelCallback")));
    ...
    public static PTP_CLEANUP_GROUP_CANCEL_CALLBACK CleanupGroupCancelCallback (MemorySegment segment) {
        return PTP_CLEANUP_GROUP_CANCEL_CALLBACK.ofAddress(CleanupGroupCancelCallback$get(segment));
    }
    static final VarHandle RaceDll$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("RaceDll")));
    ...
    static final VarHandle ActivationContext$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ActivationContext")));
    ...
    static final VarHandle FinalizationCallback$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("FinalizationCallback")));
    ...
    public static PTP_SIMPLE_CALLBACK FinalizationCallback (MemorySegment segment) {
        return PTP_SIMPLE_CALLBACK.ofAddress(FinalizationCallback$get(segment));
    }
    public static class u {
        ...
        static final VarHandle Flags$VH = u$union$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Flags"));
        ...
        public static class s {
            ...
            static final MemoryLayout u$s$struct$LAYOUT = MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("LongFunction"),
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("Persistent"),
                    MemoryLayout.valueLayout(30, ByteOrder.nativeOrder()).withName("Private")
    ...
    static final VarHandle CallbackPriority$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("CallbackPriority"));
