...
public class tagTOUCHINPUT {
    ...
    static final VarHandle hSource$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hSource")));
    ...
    static final VarHandle dwMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwMask"));
    ...
    static final VarHandle cxContact$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cxContact"));
    ...
    static final VarHandle cyContact$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cyContact"));
