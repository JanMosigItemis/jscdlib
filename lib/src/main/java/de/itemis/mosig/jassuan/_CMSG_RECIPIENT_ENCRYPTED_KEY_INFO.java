...
public class _CMSG_RECIPIENT_ENCRYPTED_KEY_INFO {
    ...
    public static MemoryAddress pOtherAttr$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCRYPTED_KEY_INFO.pOtherAttr$VH.get(seg);
    }
    ...
    public static MemoryAddress pOtherAttr$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CMSG_RECIPIENT_ENCRYPTED_KEY_INFO.pOtherAttr$VH.get(seg.asSlice(index*sizeof()));
    }
