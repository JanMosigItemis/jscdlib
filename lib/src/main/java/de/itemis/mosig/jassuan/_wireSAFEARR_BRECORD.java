...
public class _wireSAFEARR_BRECORD {
    ...
    static final VarHandle aRecord$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("aRecord")));
    ...
    public static MemoryAddress aRecord$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_wireSAFEARR_BRECORD.aRecord$VH.get(seg);
    }
    ...
    public static MemoryAddress aRecord$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_wireSAFEARR_BRECORD.aRecord$VH.get(seg.asSlice(index*sizeof()));
    }
