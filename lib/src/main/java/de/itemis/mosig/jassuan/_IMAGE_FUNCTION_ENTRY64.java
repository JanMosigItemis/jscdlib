...
public class _IMAGE_FUNCTION_ENTRY64 {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG_LONG.withName("StartingAddress"),
        C_LONG_LONG.withName("EndingAddress"),
        MemoryLayout.unionLayout(
            C_LONG_LONG.withName("EndOfPrologue"),
            C_LONG_LONG.withName("UnwindInfoAddress")
        ).withName("$anon$0")
    ).withName("_IMAGE_FUNCTION_ENTRY64");
    public static MemoryLayout $LAYOUT() {
        return _IMAGE_FUNCTION_ENTRY64.$struct$LAYOUT;
    }
    static final VarHandle StartingAddress$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("StartingAddress"));
    ...
    static final VarHandle EndingAddress$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("EndingAddress"));
    ...
    static final VarHandle EndOfPrologue$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("EndOfPrologue"));
    ...
    static final VarHandle UnwindInfoAddress$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("UnwindInfoAddress"));
