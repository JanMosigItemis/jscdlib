...
public class tagUPDATELAYEREDWINDOWINFO {
    ...
    static final VarHandle hdcDst$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hdcDst")));
    ...
    static final VarHandle pptDst$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pptDst")));
    ...
    static final VarHandle psize$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("psize")));
    ...
    static final VarHandle hdcSrc$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hdcSrc")));
    ...
    static final VarHandle pptSrc$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pptSrc")));
    ...
    static final VarHandle crKey$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("crKey"));
    ...
    static final VarHandle pblend$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("pblend")));
    ...
    static final VarHandle prcDirty$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("prcDirty")));
