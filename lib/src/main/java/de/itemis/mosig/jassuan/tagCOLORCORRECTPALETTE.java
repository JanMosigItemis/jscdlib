...
public class tagCOLORCORRECTPALETTE {
    ...
    static final VarHandle ihPalette$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ihPalette"));
    ...
    static final VarHandle nFirstEntry$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nFirstEntry"));
    ...
    static final VarHandle nReserved$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nReserved"));
