...
public class _OVERLAPPED {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_LONG_LONG.withName("InternalHigh"),
    ...
    static final VarHandle InternalHigh$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("InternalHigh"));
    ...
    static final VarHandle Offset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("Offset"));
    ...
    static final VarHandle OffsetHigh$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("OffsetHigh"));
    ...
    static final VarHandle Pointer$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("Pointer")));
    ...
    static final VarHandle hEvent$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("hEvent")));
