...
public class tagMCI_WAVE_OPEN_PARMSW {
    ...
    public static MemoryAddress lpstrDeviceType$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_WAVE_OPEN_PARMSW.lpstrDeviceType$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrDeviceType$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_WAVE_OPEN_PARMSW.lpstrDeviceType$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrElementName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_WAVE_OPEN_PARMSW.lpstrElementName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrElementName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_WAVE_OPEN_PARMSW.lpstrElementName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrAlias$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_WAVE_OPEN_PARMSW.lpstrAlias$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrAlias$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_WAVE_OPEN_PARMSW.lpstrAlias$VH.get(seg.asSlice(index*sizeof()));
    }
