...
public class _CRYPT_PASSWORD_CREDENTIALSW {
    ...
    public static MemoryAddress pszUsername$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_PASSWORD_CREDENTIALSW.pszUsername$VH.get(seg);
    }
    ...
    public static MemoryAddress pszUsername$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_PASSWORD_CREDENTIALSW.pszUsername$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pszPassword$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_PASSWORD_CREDENTIALSW.pszPassword$VH.get(seg);
    }
    ...
    public static MemoryAddress pszPassword$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_PASSWORD_CREDENTIALSW.pszPassword$VH.get(seg.asSlice(index*sizeof()));
    }
