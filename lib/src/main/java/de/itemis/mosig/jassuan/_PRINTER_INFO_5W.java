...
public class _PRINTER_INFO_5W {
    ...
    public static MemoryAddress pPrinterName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_5W.pPrinterName$VH.get(seg);
    }
    ...
    public static MemoryAddress pPrinterName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_5W.pPrinterName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pPortName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_5W.pPortName$VH.get(seg);
    }
    ...
    public static MemoryAddress pPortName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PRINTER_INFO_5W.pPortName$VH.get(seg.asSlice(index*sizeof()));
    }
