...
public class tagRECONVERTSTRING {
    ...
    static final VarHandle dwStrLen$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwStrLen"));
    ...
    static final VarHandle dwStrOffset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwStrOffset"));
    ...
    static final VarHandle dwCompStrLen$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCompStrLen"));
    ...
    static final VarHandle dwCompStrOffset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCompStrOffset"));
    ...
    static final VarHandle dwTargetStrLen$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwTargetStrLen"));
    ...
    static final VarHandle dwTargetStrOffset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwTargetStrOffset"));
