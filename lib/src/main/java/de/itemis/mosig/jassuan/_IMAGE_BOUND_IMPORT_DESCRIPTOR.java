...
public class _IMAGE_BOUND_IMPORT_DESCRIPTOR {
    ...
    static final VarHandle OffsetModuleName$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("OffsetModuleName"));
    ...
    static final VarHandle NumberOfModuleForwarderRefs$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("NumberOfModuleForwarderRefs"));
