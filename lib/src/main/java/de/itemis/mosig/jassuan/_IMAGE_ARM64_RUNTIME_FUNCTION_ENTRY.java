        ...
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    ...
                    MemoryLayout.valueLayout(3, ByteOrder.nativeOrder()).withName("RegF"),
                    MemoryLayout.valueLayout(4, ByteOrder.nativeOrder()).withName("RegI"),
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("H"),
                    MemoryLayout.valueLayout(2, ByteOrder.nativeOrder()).withName("CR"),
                    MemoryLayout.valueLayout(9, ByteOrder.nativeOrder()).withName("FrameSize")
                )
            ).withName("$anon$0")
        ).withName("$anon$0")
