...
public class _CRYPT_CONTEXT_FUNCTION_PROVIDERS {
    ...
    public static MemoryAddress rgpszProviders$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_CONTEXT_FUNCTION_PROVIDERS.rgpszProviders$VH.get(seg);
    }
    ...
    public static MemoryAddress rgpszProviders$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_CONTEXT_FUNCTION_PROVIDERS.rgpszProviders$VH.get(seg.asSlice(index*sizeof()));
    }
