...
public class tagCALPSTR {
    ...
    public static MemoryAddress pElems$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagCALPSTR.pElems$VH.get(seg);
    }
    ...
    public static MemoryAddress pElems$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagCALPSTR.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
