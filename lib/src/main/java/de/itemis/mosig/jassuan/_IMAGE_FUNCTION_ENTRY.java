...
public class _IMAGE_FUNCTION_ENTRY {
    ...
    static final VarHandle StartingAddress$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("StartingAddress"));
    ...
    static final VarHandle EndingAddress$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EndingAddress"));
    ...
    static final VarHandle EndOfPrologue$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EndOfPrologue"));
