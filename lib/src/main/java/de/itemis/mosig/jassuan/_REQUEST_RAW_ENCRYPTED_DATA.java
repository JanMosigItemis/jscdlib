...
public class _REQUEST_RAW_ENCRYPTED_DATA {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG_LONG.withName("FileOffset"),
    ...
    static final VarHandle FileOffset$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("FileOffset"));
