...
public class _SERVICE_FAILURE_ACTIONSW {
    ...
    static final VarHandle dwResetPeriod$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwResetPeriod"));
    ...
    static final VarHandle lpRebootMsg$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpRebootMsg")));
    ...
    public static MemoryAddress lpRebootMsg$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_FAILURE_ACTIONSW.lpRebootMsg$VH.get(seg);
    }
    ...
    public static MemoryAddress lpRebootMsg$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_FAILURE_ACTIONSW.lpRebootMsg$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpCommand$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpCommand")));
    ...
    public static MemoryAddress lpCommand$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_FAILURE_ACTIONSW.lpCommand$VH.get(seg);
    }
    ...
    public static MemoryAddress lpCommand$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_FAILURE_ACTIONSW.lpCommand$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle cActions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cActions"));
    ...
    static final VarHandle lpsaActions$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpsaActions")));
    ...
    public static MemoryAddress lpsaActions$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_FAILURE_ACTIONSW.lpsaActions$VH.get(seg);
    }
    ...
    public static MemoryAddress lpsaActions$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_FAILURE_ACTIONSW.lpsaActions$VH.get(seg.asSlice(index*sizeof()));
    }
