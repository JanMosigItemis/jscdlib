...
public class _IMAGE_EXPORT_DIRECTORY {
    ...
    static final VarHandle Name$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Name"));
    ...
    static final VarHandle Base$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Base"));
    ...
    static final VarHandle NumberOfFunctions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("NumberOfFunctions"));
    ...
    static final VarHandle NumberOfNames$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("NumberOfNames"));
    ...
    static final VarHandle AddressOfFunctions$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AddressOfFunctions"));
    ...
    static final VarHandle AddressOfNames$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AddressOfNames"));
    ...
    static final VarHandle AddressOfNameOrdinals$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AddressOfNameOrdinals"));
