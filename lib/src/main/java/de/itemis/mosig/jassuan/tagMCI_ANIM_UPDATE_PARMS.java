...
public class tagMCI_ANIM_UPDATE_PARMS {
    ...
    public static MemoryAddress hDC$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_ANIM_UPDATE_PARMS.hDC$VH.get(seg);
    }
    ...
    public static MemoryAddress hDC$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_ANIM_UPDATE_PARMS.hDC$VH.get(seg.asSlice(index*sizeof()));
    }
