...
public class _ACL {
    ...
    static final VarHandle AclRevision$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("AclRevision"));
    ...
    static final VarHandle AclSize$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AclSize"));
    ...
    static final VarHandle AceCount$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AceCount"));
    ...
    static final VarHandle Sbz2$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("Sbz2"));
