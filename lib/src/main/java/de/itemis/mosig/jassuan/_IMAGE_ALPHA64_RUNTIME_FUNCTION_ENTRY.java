...
public class _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG_LONG.withName("BeginAddress"),
        C_LONG_LONG.withName("EndAddress"),
        C_LONG_LONG.withName("ExceptionHandler"),
        C_LONG_LONG.withName("HandlerData"),
        C_LONG_LONG.withName("PrologEndAddress")
    ).withName("_IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY");
    public static MemoryLayout $LAYOUT() {
        return _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY.$struct$LAYOUT;
    }
    static final VarHandle BeginAddress$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("BeginAddress"));
    ...
    static final VarHandle EndAddress$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("EndAddress"));
    ...
    static final VarHandle ExceptionHandler$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ExceptionHandler"));
    ...
    static final VarHandle HandlerData$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("HandlerData"));
    ...
    static final VarHandle PrologEndAddress$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("PrologEndAddress"));
