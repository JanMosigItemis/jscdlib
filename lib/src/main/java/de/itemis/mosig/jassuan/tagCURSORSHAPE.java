...
public class tagCURSORSHAPE {
    ...
    static final VarHandle cbWidth$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cbWidth"));
    ...
    static final VarHandle Planes$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("Planes"));
    ...
    static final VarHandle BitsPixel$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("BitsPixel"));
