...
public class _CRYPT_KEY_SIGN_MESSAGE_PARA {
    ...
    public static MemoryAddress pvHashAuxInfo$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_KEY_SIGN_MESSAGE_PARA.pvHashAuxInfo$VH.get(seg);
    }
    ...
    public static MemoryAddress pvHashAuxInfo$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_CRYPT_KEY_SIGN_MESSAGE_PARA.pvHashAuxInfo$VH.get(seg.asSlice(index*sizeof()));
    }
