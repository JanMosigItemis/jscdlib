...
public class _wireSAFEARR_VARIANT {
    ...
    static final VarHandle aVariant$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("aVariant")));
    ...
    public static MemoryAddress aVariant$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_wireSAFEARR_VARIANT.aVariant$VH.get(seg);
    }
    ...
    public static MemoryAddress aVariant$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_wireSAFEARR_VARIANT.aVariant$VH.get(seg.asSlice(index*sizeof()));
    }
