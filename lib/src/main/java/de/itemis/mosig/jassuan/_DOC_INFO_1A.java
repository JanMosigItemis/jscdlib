...
public class _DOC_INFO_1A {
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_1A.pDocName$VH.get(seg);
    }
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_1A.pDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_1A.pOutputFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_1A.pOutputFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_1A.pDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOC_INFO_1A.pDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
