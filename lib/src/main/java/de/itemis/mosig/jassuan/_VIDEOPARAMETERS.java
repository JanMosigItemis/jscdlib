...
public class _VIDEOPARAMETERS {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, C_CHAR).withName("bOEMCopyProtection")
    ...
    static final VarHandle dwCommand$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCommand"));
    ...
    static final VarHandle dwTVStandard$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwTVStandard"));
    ...
    static final VarHandle dwAvailableModes$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwAvailableModes"));
    ...
    static final VarHandle dwAvailableTVStandard$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwAvailableTVStandard"));
    ...
    static final VarHandle dwFlickerFilter$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFlickerFilter"));
    ...
    static final VarHandle dwOverScanX$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwOverScanX"));
    ...
    static final VarHandle dwOverScanY$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwOverScanY"));
    ...
    static final VarHandle dwMaxUnscaledX$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwMaxUnscaledX"));
    ...
    static final VarHandle dwMaxUnscaledY$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwMaxUnscaledY"));
    ...
    static final VarHandle dwPositionX$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwPositionX"));
    ...
    static final VarHandle dwPositionY$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwPositionY"));
    ...
    static final VarHandle dwBrightness$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwBrightness"));
    ...
    static final VarHandle dwContrast$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwContrast"));
    ...
    static final VarHandle dwCPType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCPType"));
    ...
    static final VarHandle dwCPCommand$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCPCommand"));
    ...
    static final VarHandle dwCPStandard$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCPStandard"));
    ...
    static final VarHandle dwCPKey$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCPKey"));
    ...
    static final VarHandle bCP_APSTriggerBits$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("bCP_APSTriggerBits"));
