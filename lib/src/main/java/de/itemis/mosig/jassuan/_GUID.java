...
public class _GUID {
    ...
    static final VarHandle Data1$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Data1"));
    ...
    static final VarHandle Data2$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("Data2"));
    ...
    static final VarHandle Data3$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("Data3"));
