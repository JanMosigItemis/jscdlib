...
public class _MONITOR_INFO_2W {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_MONITOR_INFO_2W.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_MONITOR_INFO_2W.pName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_MONITOR_INFO_2W.pEnvironment$VH.get(seg);
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_MONITOR_INFO_2W.pEnvironment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDLLName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_MONITOR_INFO_2W.pDLLName$VH.get(seg);
    }
    ...
    public static MemoryAddress pDLLName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_MONITOR_INFO_2W.pDLLName$VH.get(seg.asSlice(index*sizeof()));
    }
