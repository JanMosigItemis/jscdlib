...
public class tagIMECHARPOSITION {
    ...
    static final VarHandle dwCharPos$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwCharPos"));
    ...
    static final VarHandle cLineHeight$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cLineHeight"));
