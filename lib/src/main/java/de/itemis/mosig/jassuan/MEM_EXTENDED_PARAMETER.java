...
public class MEM_EXTENDED_PARAMETER {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.structLayout(
            MemoryLayout.structLayout(
                MemoryLayout.valueLayout(8, ByteOrder.nativeOrder()).withName("Type"),
                MemoryLayout.valueLayout(56, ByteOrder.nativeOrder()).withName("Reserved")
            )
        ).withName("$anon$0"),
        MemoryLayout.unionLayout(
            C_LONG_LONG.withName("ULong64"),
    ...
    static final VarHandle ULong64$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$1"), MemoryLayout.PathElement.groupElement("ULong64"));
    ...
    static final VarHandle Pointer$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$1"), MemoryLayout.PathElement.groupElement("Pointer")));
    ...
    static final VarHandle Size$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$1"), MemoryLayout.PathElement.groupElement("Size"));
    ...
    static final VarHandle Handle$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("$anon$1"), MemoryLayout.PathElement.groupElement("Handle")));
    ...
    static final VarHandle ULong$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$1"), MemoryLayout.PathElement.groupElement("ULong"));
