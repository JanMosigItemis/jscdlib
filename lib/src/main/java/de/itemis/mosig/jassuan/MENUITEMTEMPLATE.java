...
public class MENUITEMTEMPLATE {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, C_SHORT).withName("mtString")
    );
    public static MemoryLayout $LAYOUT() {
        return MENUITEMTEMPLATE.$struct$LAYOUT;
    }
    static final VarHandle mtOption$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("mtOption"));
    ...
    static final VarHandle mtID$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("mtID"));
