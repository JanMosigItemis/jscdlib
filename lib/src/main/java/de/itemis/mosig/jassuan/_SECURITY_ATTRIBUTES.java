...
public class _SECURITY_ATTRIBUTES {
    ...
    static final VarHandle lpSecurityDescriptor$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpSecurityDescriptor")));
