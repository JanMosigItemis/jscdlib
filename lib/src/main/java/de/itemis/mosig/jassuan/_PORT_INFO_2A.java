...
public class _PORT_INFO_2A {
    ...
    public static MemoryAddress pPortName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_2A.pPortName$VH.get(seg);
    }
    ...
    public static MemoryAddress pPortName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_2A.pPortName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pMonitorName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_2A.pMonitorName$VH.get(seg);
    }
    ...
    public static MemoryAddress pMonitorName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_2A.pMonitorName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDescription$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_2A.pDescription$VH.get(seg);
    }
    ...
    public static MemoryAddress pDescription$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PORT_INFO_2A.pDescription$VH.get(seg.asSlice(index*sizeof()));
    }
