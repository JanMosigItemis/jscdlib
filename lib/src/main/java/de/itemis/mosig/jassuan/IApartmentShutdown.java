...
public class IApartmentShutdown {
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)IApartmentShutdown.lpVtbl$VH.get(seg);
    }
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)IApartmentShutdown.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
