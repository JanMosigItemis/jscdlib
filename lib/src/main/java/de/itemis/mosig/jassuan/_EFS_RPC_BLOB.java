...
public class _EFS_RPC_BLOB {
    ...
    public static MemoryAddress pbData$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_EFS_RPC_BLOB.pbData$VH.get(seg);
    }
    ...
    public static MemoryAddress pbData$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_EFS_RPC_BLOB.pbData$VH.get(seg.asSlice(index*sizeof()));
    }
