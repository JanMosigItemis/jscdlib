...
public class _FILE_SEGMENT_ELEMENT {
    ...
    static final VarHandle Buffer$VH = MemoryHandles.asAddressVarHandle($union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Buffer")));
    ...
    static final VarHandle Alignment$VH = $union$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Alignment"));
