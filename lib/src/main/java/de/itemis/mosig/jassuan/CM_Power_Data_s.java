...
public class CM_Power_Data_s {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(7, C_INT).withName("PD_PowerStateMapping"),
        C_INT.withName("PD_DeepestSystemWake")
    ).withName("CM_Power_Data_s");
    public static MemoryLayout $LAYOUT() {
        return CM_Power_Data_s.$struct$LAYOUT;
    }
    static final VarHandle PD_Size$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_Size"));
    ...
    static final VarHandle PD_MostRecentPowerState$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_MostRecentPowerState"));
    ...
    static final VarHandle PD_Capabilities$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_Capabilities"));
    ...
    static final VarHandle PD_D1Latency$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_D1Latency"));
    ...
    static final VarHandle PD_D2Latency$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_D2Latency"));
    ...
    static final VarHandle PD_D3Latency$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_D3Latency"));
    ...
    static final VarHandle PD_DeepestSystemWake$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PD_DeepestSystemWake"));
