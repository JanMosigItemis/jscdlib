...
public class tagDRAWTEXTPARAMS {
    ...
    static final VarHandle iTabLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iTabLength"));
    ...
    static final VarHandle iLeftMargin$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iLeftMargin"));
    ...
    static final VarHandle iRightMargin$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iRightMargin"));
    ...
    static final VarHandle uiLengthDrawn$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("uiLengthDrawn"));
