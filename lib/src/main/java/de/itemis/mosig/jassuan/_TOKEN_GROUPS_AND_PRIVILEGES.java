...
public class _TOKEN_GROUPS_AND_PRIVILEGES {
    ...
    static final VarHandle SidLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("SidLength"));
    ...
    static final VarHandle Sids$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("Sids")));
    ...
    static final VarHandle RestrictedSidCount$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("RestrictedSidCount"));
    ...
    static final VarHandle RestrictedSidLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("RestrictedSidLength"));
    ...
    static final VarHandle RestrictedSids$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("RestrictedSids")));
    ...
    static final VarHandle PrivilegeLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("PrivilegeLength"));
