...
public class _IMAGE_RUNTIME_FUNCTION_ENTRY {
    ...
    static final VarHandle UnwindInfoAddress$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("UnwindInfoAddress"));
