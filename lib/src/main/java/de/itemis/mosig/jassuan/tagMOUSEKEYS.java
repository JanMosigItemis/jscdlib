...
public class tagMOUSEKEYS {
    ...
    static final VarHandle iMaxSpeed$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iMaxSpeed"));
    ...
    static final VarHandle iTimeToMaxSpeed$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iTimeToMaxSpeed"));
    ...
    static final VarHandle iCtrlSpeed$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("iCtrlSpeed"));
