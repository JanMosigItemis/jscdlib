...
public class tagHELPWININFOW {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_INT.withName("dy"),
        C_INT.withName("wMax"),
        MemoryLayout.sequenceLayout(2, C_SHORT).withName("rgchMember")
    ).withName("tagHELPWININFOW");
    public static MemoryLayout $LAYOUT() {
        return tagHELPWININFOW.$struct$LAYOUT;
    }
    static final VarHandle wStructSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("wStructSize"));
    ...
    static final VarHandle wMax$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("wMax"));
