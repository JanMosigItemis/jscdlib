...
public class tagMCI_SYSINFO_PARMSW {
    ...
    public static MemoryAddress lpstrReturn$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_SYSINFO_PARMSW.lpstrReturn$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrReturn$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)tagMCI_SYSINFO_PARMSW.lpstrReturn$VH.get(seg.asSlice(index*sizeof()));
    }
