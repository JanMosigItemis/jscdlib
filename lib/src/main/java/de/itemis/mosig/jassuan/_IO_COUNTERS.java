...
public class _IO_COUNTERS {
    ...
    static final VarHandle ReadOperationCount$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ReadOperationCount"));
    ...
    static final VarHandle WriteOperationCount$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("WriteOperationCount"));
    ...
    static final VarHandle OtherOperationCount$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("OtherOperationCount"));
    ...
    static final VarHandle ReadTransferCount$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ReadTransferCount"));
    ...
    static final VarHandle WriteTransferCount$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("WriteTransferCount"));
    ...
    static final VarHandle OtherTransferCount$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("OtherTransferCount"));
