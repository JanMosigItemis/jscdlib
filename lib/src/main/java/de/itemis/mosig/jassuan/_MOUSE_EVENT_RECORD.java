...
public class _MOUSE_EVENT_RECORD {
    ...
    static final VarHandle dwButtonState$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwButtonState"));
    ...
    static final VarHandle dwEventFlags$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwEventFlags"));
