...
public class _ACE_HEADER {
    ...
    static final VarHandle AceType$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("AceType"));
    ...
    static final VarHandle AceFlags$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("AceFlags"));
    ...
    static final VarHandle AceSize$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AceSize"));
