...
public class _JOBOBJECT_SECURITY_LIMIT_INFORMATION {
    ...
    static final VarHandle SecurityLimitFlags$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("SecurityLimitFlags"));
    ...
    static final VarHandle JobToken$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("JobToken")));
    ...
    static final VarHandle SidsToDisable$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("SidsToDisable")));
    ...
    static final VarHandle PrivilegesToDelete$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("PrivilegesToDelete")));
