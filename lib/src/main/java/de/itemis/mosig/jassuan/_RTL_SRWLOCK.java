...
public class _RTL_SRWLOCK {
    ...
    public static MemoryAddress Ptr$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_RTL_SRWLOCK.Ptr$VH.get(seg);
    }
    ...
    public static MemoryAddress Ptr$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_RTL_SRWLOCK.Ptr$VH.get(seg.asSlice(index*sizeof()));
    }
