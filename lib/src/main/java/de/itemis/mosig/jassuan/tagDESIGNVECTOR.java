...
public class tagDESIGNVECTOR {
    ...
    static final VarHandle dvReserved$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dvReserved"));
    ...
    static final VarHandle dvNumAxes$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dvNumAxes"));
