...
public class _finddata32_t {
    ...
    public static MemoryLayout $LAYOUT() {
        return _finddata32_t.$struct$LAYOUT;
    }
    ...
    public static VarHandle attrib$VH() {
        return _finddata32_t.attrib$VH;
    }
    public static int attrib$get(MemorySegment seg) {
        return (int)_finddata32_t.attrib$VH.get(seg);
    }
    public static void attrib$set( MemorySegment seg, int x) {
        _finddata32_t.attrib$VH.set(seg, x);
    }
    public static int attrib$get(MemorySegment seg, long index) {
        return (int)_finddata32_t.attrib$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void attrib$set(MemorySegment seg, long index, int x) {
        _finddata32_t.attrib$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle time_create$VH() {
        return _finddata32_t.time_create$VH;
    }
    public static int time_create$get(MemorySegment seg) {
        return (int)_finddata32_t.time_create$VH.get(seg);
    }
    public static void time_create$set( MemorySegment seg, int x) {
        _finddata32_t.time_create$VH.set(seg, x);
    }
    public static int time_create$get(MemorySegment seg, long index) {
        return (int)_finddata32_t.time_create$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void time_create$set(MemorySegment seg, long index, int x) {
        _finddata32_t.time_create$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle time_access$VH() {
        return _finddata32_t.time_access$VH;
    }
    public static int time_access$get(MemorySegment seg) {
        return (int)_finddata32_t.time_access$VH.get(seg);
    }
    public static void time_access$set( MemorySegment seg, int x) {
        _finddata32_t.time_access$VH.set(seg, x);
    }
    public static int time_access$get(MemorySegment seg, long index) {
        return (int)_finddata32_t.time_access$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void time_access$set(MemorySegment seg, long index, int x) {
        _finddata32_t.time_access$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle time_write$VH() {
        return _finddata32_t.time_write$VH;
    }
    public static int time_write$get(MemorySegment seg) {
        return (int)_finddata32_t.time_write$VH.get(seg);
    }
    public static void time_write$set( MemorySegment seg, int x) {
        _finddata32_t.time_write$VH.set(seg, x);
    }
    public static int time_write$get(MemorySegment seg, long index) {
        return (int)_finddata32_t.time_write$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void time_write$set(MemorySegment seg, long index, int x) {
        _finddata32_t.time_write$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle size$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("size"));
    public static VarHandle size$VH() {
        return _finddata32_t.size$VH;
    }
    public static int size$get(MemorySegment seg) {
        return (int)_finddata32_t.size$VH.get(seg);
    }
    public static void size$set( MemorySegment seg, int x) {
        _finddata32_t.size$VH.set(seg, x);
    }
    public static int size$get(MemorySegment seg, long index) {
        return (int)_finddata32_t.size$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void size$set(MemorySegment seg, long index, int x) {
        _finddata32_t.size$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static MemorySegment name$slice(MemorySegment seg) {
        return seg.asSlice(20, 260);
    }
