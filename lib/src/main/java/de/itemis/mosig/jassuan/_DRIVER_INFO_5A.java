...
public class _DRIVER_INFO_5A {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pEnvironment$VH.get(seg);
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pEnvironment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDriverPath$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pDriverPath$VH.get(seg);
    }
    ...
    public static MemoryAddress pDriverPath$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pDriverPath$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDataFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pDataFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pDataFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pDataFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pConfigFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pConfigFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pConfigFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_5A.pConfigFile$VH.get(seg.asSlice(index*sizeof()));
    }
