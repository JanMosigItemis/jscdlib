...
public class _WSANAMESPACE_INFOEXW {
    ...
    public static MemoryAddress lpszIdentifier$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_WSANAMESPACE_INFOEXW.lpszIdentifier$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszIdentifier$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_WSANAMESPACE_INFOEXW.lpszIdentifier$VH.get(seg.asSlice(index*sizeof()));
    }
