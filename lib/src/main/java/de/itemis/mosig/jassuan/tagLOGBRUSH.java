...
public class tagLOGBRUSH {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        C_LONG_LONG.withName("lbHatch")
    ).withName("tagLOGBRUSH");
    public static MemoryLayout $LAYOUT() {
        return tagLOGBRUSH.$struct$LAYOUT;
    }
    static final VarHandle lbStyle$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("lbStyle"));
    ...
    static final VarHandle lbColor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("lbColor"));
    ...
    static final VarHandle lbHatch$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lbHatch"));
