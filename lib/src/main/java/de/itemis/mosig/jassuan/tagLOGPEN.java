...
public class tagLOGPEN {
    ...
    static final VarHandle lopnStyle$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("lopnStyle"));
    ...
    static final VarHandle lopnColor$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("lopnColor"));
