...
public class tagWINDOWINFO {
    ...
    static final VarHandle dwWindowStatus$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwWindowStatus"));
    ...
    static final VarHandle cxWindowBorders$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cxWindowBorders"));
    ...
    static final VarHandle cyWindowBorders$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("cyWindowBorders"));
    ...
    static final VarHandle atomWindowType$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("atomWindowType"));
    ...
    static final VarHandle wCreatorVersion$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("wCreatorVersion"));
