...
public class tagBITMAPFILEHEADER {
    ...
    static final VarHandle bfType$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bfType"));
    ...
    static final VarHandle bfSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("bfSize"));
    ...
    static final VarHandle bfReserved1$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bfReserved1"));
    ...
    static final VarHandle bfReserved2$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("bfReserved2"));
    ...
    static final VarHandle bfOffBits$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("bfOffBits"));
