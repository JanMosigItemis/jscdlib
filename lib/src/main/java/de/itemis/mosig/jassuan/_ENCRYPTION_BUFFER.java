...
public class _ENCRYPTION_BUFFER {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, C_CHAR).withName("Private"),
        MemoryLayout.paddingLayout(24)
    ).withName("_ENCRYPTION_BUFFER");
    public static MemoryLayout $LAYOUT() {
        return _ENCRYPTION_BUFFER.$struct$LAYOUT;
    }
    static final VarHandle EncryptionOperation$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EncryptionOperation"));
