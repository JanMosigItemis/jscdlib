...
public class _finddata32i64_t {
    ...
    public static MemoryLayout $LAYOUT() {
        return _finddata32i64_t.$struct$LAYOUT;
    }
    ...
    public static VarHandle attrib$VH() {
        return _finddata32i64_t.attrib$VH;
    }
    public static int attrib$get(MemorySegment seg) {
        return (int)_finddata32i64_t.attrib$VH.get(seg);
    }
    public static void attrib$set( MemorySegment seg, int x) {
        _finddata32i64_t.attrib$VH.set(seg, x);
    }
    public static int attrib$get(MemorySegment seg, long index) {
        return (int)_finddata32i64_t.attrib$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void attrib$set(MemorySegment seg, long index, int x) {
        _finddata32i64_t.attrib$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle time_create$VH() {
        return _finddata32i64_t.time_create$VH;
    }
    public static int time_create$get(MemorySegment seg) {
        return (int)_finddata32i64_t.time_create$VH.get(seg);
    }
    public static void time_create$set( MemorySegment seg, int x) {
        _finddata32i64_t.time_create$VH.set(seg, x);
    }
    public static int time_create$get(MemorySegment seg, long index) {
        return (int)_finddata32i64_t.time_create$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void time_create$set(MemorySegment seg, long index, int x) {
        _finddata32i64_t.time_create$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle time_access$VH() {
        return _finddata32i64_t.time_access$VH;
    }
    public static int time_access$get(MemorySegment seg) {
        return (int)_finddata32i64_t.time_access$VH.get(seg);
    }
    public static void time_access$set( MemorySegment seg, int x) {
        _finddata32i64_t.time_access$VH.set(seg, x);
    }
    public static int time_access$get(MemorySegment seg, long index) {
        return (int)_finddata32i64_t.time_access$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void time_access$set(MemorySegment seg, long index, int x) {
        _finddata32i64_t.time_access$VH.set(seg.asSlice(index*sizeof()), x);
    }
