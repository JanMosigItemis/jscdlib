...
public class tagEMRANGLEARC {
    ...
    static final VarHandle nRadius$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nRadius"));
    ...
    static final VarHandle eStartAngle$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eStartAngle"));
    ...
    static final VarHandle eSweepAngle$VH = $struct$LAYOUT.varHandle(float.class, MemoryLayout.PathElement.groupElement("eSweepAngle"));
