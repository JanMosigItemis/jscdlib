...
public class _IMAGE_LINENUMBER {
    ...
    public static class Type {
        ...
        static final MemoryLayout Type$union$LAYOUT = MemoryLayout.unionLayout(
            C_LONG.withName("SymbolTableIndex"),
            C_LONG.withName("VirtualAddress")
        );
        public static MemoryLayout $LAYOUT() {
        ...
        static final VarHandle SymbolTableIndex$VH = Type$union$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("SymbolTableIndex"));
        ...
        static final VarHandle VirtualAddress$VH = Type$union$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("VirtualAddress"));
    ...
    static final VarHandle Linenumber$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("Linenumber"));
