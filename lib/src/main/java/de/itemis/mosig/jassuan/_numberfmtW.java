...
public class _numberfmtW {
    ...
    public static MemoryAddress lpDecimalSep$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_numberfmtW.lpDecimalSep$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDecimalSep$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_numberfmtW.lpDecimalSep$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpThousandSep$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_numberfmtW.lpThousandSep$VH.get(seg);
    }
    ...
    public static MemoryAddress lpThousandSep$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_numberfmtW.lpThousandSep$VH.get(seg.asSlice(index*sizeof()));
    }
