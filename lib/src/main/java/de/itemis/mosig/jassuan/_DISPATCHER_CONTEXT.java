...
public class _DISPATCHER_CONTEXT {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_LONG_LONG.withName("ControlPc"),
        C_LONG_LONG.withName("ImageBase"),
        C_POINTER.withName("FunctionEntry"),
        C_LONG_LONG.withName("EstablisherFrame"),
        C_LONG_LONG.withName("TargetIp"),
    ...
    static final VarHandle ControlPc$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ControlPc"));
    ...
    static final VarHandle ImageBase$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("ImageBase"));
    ...
    static final VarHandle FunctionEntry$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("FunctionEntry")));
    ...
    static final VarHandle EstablisherFrame$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("EstablisherFrame"));
    ...
    static final VarHandle TargetIp$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("TargetIp"));
    ...
    static final VarHandle LanguageHandler$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("LanguageHandler")));
    ...
    public static PEXCEPTION_ROUTINE LanguageHandler (MemorySegment segment) {
        return PEXCEPTION_ROUTINE.ofAddress(LanguageHandler$get(segment));
    }
    static final VarHandle HandlerData$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("HandlerData")));
    ...
    static final VarHandle HistoryTable$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("HistoryTable")));
    ...
    static final VarHandle ScopeIndex$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ScopeIndex"));
    ...
    static final VarHandle Fill0$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("Fill0"));
