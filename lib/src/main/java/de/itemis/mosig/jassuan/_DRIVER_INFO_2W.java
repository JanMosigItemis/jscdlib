...
public class _DRIVER_INFO_2W {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pEnvironment$VH.get(seg);
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pEnvironment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDriverPath$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pDriverPath$VH.get(seg);
    }
    ...
    public static MemoryAddress pDriverPath$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pDriverPath$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDataFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pDataFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pDataFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pDataFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pConfigFile$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pConfigFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pConfigFile$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DRIVER_INFO_2W.pConfigFile$VH.get(seg.asSlice(index*sizeof()));
    }
