...
public class tagVS_FIXEDFILEINFO {
    ...
    static final VarHandle dwSignature$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwSignature"));
    ...
    static final VarHandle dwStrucVersion$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwStrucVersion"));
    ...
    static final VarHandle dwFileVersionMS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileVersionMS"));
    ...
    static final VarHandle dwFileVersionLS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileVersionLS"));
    ...
    static final VarHandle dwProductVersionMS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProductVersionMS"));
    ...
    static final VarHandle dwProductVersionLS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwProductVersionLS"));
    ...
    static final VarHandle dwFileFlagsMask$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileFlagsMask"));
    ...
    static final VarHandle dwFileFlags$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileFlags"));
    ...
    static final VarHandle dwFileOS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileOS"));
    ...
    static final VarHandle dwFileSubtype$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileSubtype"));
    ...
    static final VarHandle dwFileDateMS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileDateMS"));
    ...
    static final VarHandle dwFileDateLS$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("dwFileDateLS"));
