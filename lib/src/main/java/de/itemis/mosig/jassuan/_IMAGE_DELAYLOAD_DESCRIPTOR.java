...
public class _IMAGE_DELAYLOAD_DESCRIPTOR {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("RvaBased"),
                    MemoryLayout.valueLayout(31, ByteOrder.nativeOrder()).withName("ReservedAttributes")
                )
            ).withName("$anon$0")
        ).withName("Attributes"),
    ...
    public static class Attributes {
        ...
        static final MemoryLayout Attributes$union$LAYOUT = MemoryLayout.unionLayout(
            C_LONG.withName("AllAttributes"),
            MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    MemoryLayout.valueLayout(1, ByteOrder.nativeOrder()).withName("RvaBased"),
        ...
        static final VarHandle AllAttributes$VH = Attributes$union$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("AllAttributes"));
    ...
    static final VarHandle DllNameRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("DllNameRVA"));
    ...
    static final VarHandle ModuleHandleRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ModuleHandleRVA"));
    ...
    static final VarHandle ImportAddressTableRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ImportAddressTableRVA"));
    ...
    static final VarHandle ImportNameTableRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ImportNameTableRVA"));
    ...
    static final VarHandle BoundImportAddressTableRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("BoundImportAddressTableRVA"));
    ...
    static final VarHandle UnloadInformationTableRVA$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("UnloadInformationTableRVA"));
