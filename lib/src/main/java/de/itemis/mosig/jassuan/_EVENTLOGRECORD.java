...
public class _EVENTLOGRECORD {
    ...
    static final VarHandle RecordNumber$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("RecordNumber"));
    ...
    static final VarHandle TimeGenerated$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("TimeGenerated"));
    ...
    static final VarHandle TimeWritten$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("TimeWritten"));
    ...
    static final VarHandle EventID$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("EventID"));
    ...
    static final VarHandle NumStrings$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("NumStrings"));
    ...
    static final VarHandle EventCategory$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("EventCategory"));
    ...
    static final VarHandle ReservedFlags$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("ReservedFlags"));
    ...
    static final VarHandle ClosingRecordNumber$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ClosingRecordNumber"));
    ...
    static final VarHandle StringOffset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("StringOffset"));
    ...
    static final VarHandle UserSidLength$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("UserSidLength"));
    ...
    static final VarHandle UserSidOffset$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("UserSidOffset"));
