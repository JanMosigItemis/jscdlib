...
public class _POWER_SESSION_WINLOGON {
    ...
    static final VarHandle SessionId$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("SessionId"));
    ...
    static final VarHandle Locked$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("Locked"));
