...
public class _SYSTEM_POWER_STATUS {
    ...
    static final VarHandle ACLineStatus$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ACLineStatus"));
    ...
    static final VarHandle BatteryFlag$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("BatteryFlag"));
    ...
    static final VarHandle BatteryLifePercent$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("BatteryLifePercent"));
    ...
    public static VarHandle Reserved1$VH() {
        return _SYSTEM_POWER_STATUS.Reserved1$VH;
    }
    public static byte Reserved1$get(MemorySegment seg) {
        return (byte)_SYSTEM_POWER_STATUS.Reserved1$VH.get(seg);
    }
    public static void Reserved1$set( MemorySegment seg, byte x) {
        _SYSTEM_POWER_STATUS.Reserved1$VH.set(seg, x);
    }
    public static byte Reserved1$get(MemorySegment seg, long index) {
        return (byte)_SYSTEM_POWER_STATUS.Reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Reserved1$set(MemorySegment seg, long index, byte x) {
        _SYSTEM_POWER_STATUS.Reserved1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle BatteryLifeTime$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("BatteryLifeTime"));
    ...
    static final VarHandle BatteryFullLifeTime$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("BatteryFullLifeTime"));
