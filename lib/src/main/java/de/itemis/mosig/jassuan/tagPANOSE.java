...
public class tagPANOSE {
    ...
    static final VarHandle bFamilyType$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bFamilyType"));
    ...
    static final VarHandle bSerifStyle$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bSerifStyle"));
    ...
    static final VarHandle bWeight$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bWeight"));
    ...
    static final VarHandle bProportion$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bProportion"));
    ...
    static final VarHandle bContrast$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bContrast"));
    ...
    static final VarHandle bStrokeVariation$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bStrokeVariation"));
    ...
    static final VarHandle bArmStyle$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bArmStyle"));
    ...
    static final VarHandle bLetterform$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bLetterform"));
    ...
    static final VarHandle bMidline$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bMidline"));
    ...
    static final VarHandle bXHeight$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("bXHeight"));
