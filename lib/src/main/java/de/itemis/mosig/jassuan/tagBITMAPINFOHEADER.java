...
public class tagBITMAPINFOHEADER {
    ...
    static final VarHandle biSize$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biSize"));
    ...
    static final VarHandle biWidth$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biWidth"));
    ...
    static final VarHandle biHeight$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biHeight"));
    ...
    static final VarHandle biPlanes$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("biPlanes"));
    ...
    static final VarHandle biBitCount$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("biBitCount"));
    ...
    static final VarHandle biCompression$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biCompression"));
    ...
    static final VarHandle biSizeImage$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biSizeImage"));
    ...
    static final VarHandle biXPelsPerMeter$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biXPelsPerMeter"));
    ...
    static final VarHandle biYPelsPerMeter$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biYPelsPerMeter"));
    ...
    static final VarHandle biClrUsed$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biClrUsed"));
    ...
    static final VarHandle biClrImportant$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("biClrImportant"));
