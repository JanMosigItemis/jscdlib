...
public class _DOCINFOW {
    ...
    static final VarHandle lpszDocName$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpszDocName")));
    ...
    public static MemoryAddress lpszDocName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOCINFOW.lpszDocName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDocName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOCINFOW.lpszDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpszOutput$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpszOutput")));
    ...
    public static MemoryAddress lpszOutput$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOCINFOW.lpszOutput$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszOutput$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOCINFOW.lpszOutput$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle lpszDatatype$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("lpszDatatype")));
    ...
    public static MemoryAddress lpszDatatype$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_DOCINFOW.lpszDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDatatype$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_DOCINFOW.lpszDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle fwType$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("fwType"));
